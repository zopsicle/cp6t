...
self: {
    ...
    "Gnome::Gdk3:ver<0.14.5>" = {
        name = "Gnome::Gdk3";
        src = fetchTarball {
            url = "https://www.cpan.org/authors/id/M/MA/MARTIMM/Perl6/perl6-gnome-gdk3-0.14.5.tar.gz";
            sha256 = "1xxr9z1fs0ikkas76x3iy2p5410wg4vln8xzqglnfq0jnz36sf08";
        };
        depends = [
            self."Gnome::N"
            self."Gnome::Glib"
    ...
    "Sparky:ver<0.0.24>" = {
        name = "Sparky";
        src = fetchTarball {
            url = "https://www.cpan.org/authors/id/M/ME/MELEZHIK/Perl6/Sparky-0.0.24.tar.gz";
            sha256 = "1mrnlcxdihkcnv7pl0lvcp00hkmy8ydwvjx2j9rnicf047x0rdm9";
        };
        depends = [
            self."YAMLish"
            self."DBIish"
    ...
    "MeCab:ver<0.0.9>" = {
        name = "MeCab";
        src = fetchTarball {
            url = "https://www.cpan.org/authors/id/T/TI/TITSUKI/Perl6/MeCab-0.0.9.tar.gz";
            sha256 = "16lbbih3fpdys0wrz5n6bj723fgas8rinps41vm075q7fp8jm7bz";
        };
        depends = [
        ];
    };
