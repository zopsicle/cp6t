...
"Version::Semantic:ver<0.1.0>" = callPackage ({perl6-on-nix}:
{
...
"Sub::Memoized:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Sub::Memoized";
    src = fetchTarball {
...
"RPi::ButtonWatcher:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
...
"Lingua::Lipogram:ver<0.1.0>" = callPackage ({perl6-on-nix}:
{
...
"List::Util:ver<0.0.7>" = callPackage ({perl6-on-nix}:
{
    name = "List::Util";
    src = fetchTarball {
...
"Cache::Async:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Cache::Async";
    src = fetchTarball {
...
"Numeric::Nearest:ver<0.5.1>" = callPackage ({perl6-on-nix}:
{
...
"Math::Model:ver<0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Math::Model";
    src = fetchTarball {
...
"RDF::Turtle:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "RDF::Turtle";
    src = fetchTarball {
...
"Term::Choose:ver<1.5.7>" = callPackage ({perl6-on-nix}:
{
    name = "Term::Choose";
    src = fetchTarball {
...
"Tomtit:ver<0.0.9>" = callPackage ({perl6-on-nix}:
{
    name = "Tomtit";
    src = fetchTarball {
...
"HTTP::Request::Supply:ver<0.1.2>" = callPackage ({perl6-on-nix}:
{
...
"Tomtit:ver<0.0.27>" = callPackage ({perl6-on-nix}:
{
    name = "Tomtit";
    src = fetchTarball {
...
"JSON::Fast:ver<0.9.14>" = callPackage ({perl6-on-nix}:
{
    name = "JSON::Fast";
    src = fetchTarball {
...
"Smack:ver<0.1.1>" = callPackage ({perl6-on-nix}:
{
    name = "Smack";
    src = fetchTarball {
...
"Cofra:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Cofra";
    src = fetchTarball {
...
"MeCab:ver<0.0.9>" = callPackage ({perl6-on-nix}:
{
    name = "MeCab";
    src = fetchTarball {
...
"Acme::Cow:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Acme::Cow";
    src = fetchTarball {
...
"HTML::Canvas:ver<0.0.5>" = callPackage ({perl6-on-nix}:
{
    name = "HTML::Canvas";
    src = fetchTarball {
...
"Sub::Memoized:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Sub::Memoized";
    src = fetchTarball {
...
"I18n::Simple:ver<0.1.1>" = callPackage ({perl6-on-nix}:
{
    name = "I18n::Simple";
    src = fetchTarball {
...
"Sparrow6:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrow6";
    src = fetchTarball {
...
"Template::Anti:ver<0.4.3>" = callPackage ({perl6-on-nix}:
{
    name = "Template::Anti";
    src = fetchTarball {
...
"Vroom::Reveal:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Vroom::Reveal";
    src = fetchTarball {
...
"Serialise::Map:ver<0.1.1>" = callPackage ({perl6-on-nix}:
{
    name = "Serialise::Map";
    src = fetchTarball {
...
"IRC::Client::Plugin::UrlTitle:ver<1.0.0>" = callPackage ({perl6-on-nix}:
{
...
"Term::Choose::Util:ver<1.2.8>" = callPackage ({perl6-on-nix}:
{
...
"Tomtit:ver<0.0.5>" = callPackage ({perl6-on-nix}:
{
    name = "Tomtit";
    src = fetchTarball {
...
"JSON::Fast:ver<0.9.12>" = callPackage ({perl6-on-nix}:
{
    name = "JSON::Fast";
    src = fetchTarball {
...
"Attribute::Predicate:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
...
"Range::SetOps:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Range::SetOps";
    src = fetchTarball {
...
"MsgPack:ver<0.0.7>" = callPackage ({perl6-on-nix}:
{
    name = "MsgPack";
    src = fetchTarball {
...
"DOM::Tiny:ver<0.4.0>" = callPackage ({perl6-on-nix}:
{
    name = "DOM::Tiny";
    src = fetchTarball {
...
"Acme::Polyglot::Levenshtein::Damerau:ver<0.1>" = callPackage ({perl6-on-nix}:
{
...
"Cro::H:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Cro::H";
    src = fetchTarball {
...
"Perl6::Parser:ver<0.3.0>" = callPackage ({perl6-on-nix}:
{
    name = "Perl6::Parser";
    src = fetchTarball {
...
"Date::Names:ver<1.0.0>" = callPackage ({perl6-on-nix}:
{
    name = "Date::Names";
    src = fetchTarball {
...
"DB:ver<0.4>" = callPackage ({perl6-on-nix}:
{
    name = "DB";
    src = fetchTarball {
...
"Igo:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Igo";
    src = fetchTarball {
...
"Uzu:ver<0.3.0>" = callPackage ({perl6-on-nix}:
{
    name = "Uzu";
    src = fetchTarball {
...
"ProcStats:ver<0.2.0>" = callPackage ({perl6-on-nix}:
{
    name = "ProcStats";
    src = fetchTarball {
...
"Gnome::GObject:ver<0.13.14>" = callPackage ({perl6-on-nix}:
{
    name = "Gnome::GObject";
    src = fetchTarball {
...
"OpenAPI::Schema::Validate:ver<1.0.7>" = callPackage ({perl6-on-nix}:
{
...
"Sparrowdo::VSTS::YAML::Cordova:ver<0.0.15>" = callPackage ({perl6-on-nix}:
{
...
"Cofra:ver<0.1.0>" = callPackage ({perl6-on-nix}:
{
    name = "Cofra";
    src = fetchTarball {
...
"Sparrowdo::Cordova::OSx::Build:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
...
"App::Platform:ver<0.2.0>" = callPackage ({perl6-on-nix}:
{
    name = "App::Platform";
    src = fetchTarball {
...
"JSON::Path:ver<1.0>" = callPackage ({perl6-on-nix}:
{
    name = "JSON::Path";
    src = fetchTarball {
...
"Sparrowdo::VSTS::YAML::Build::Assembly::Patch:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
...
"Pod::Load:ver<0.1.0>" = callPackage ({perl6-on-nix}:
{
    name = "Pod::Load";
    src = fetchTarball {
...
"cro:ver<0.8.1>" = callPackage ({perl6-on-nix}:
{
    name = "cro";
    src = fetchTarball {
...
"Type::EnumHOW:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Type::EnumHOW";
    src = fetchTarball {
...
"Uzu:ver<0.2.8>" = callPackage ({perl6-on-nix}:
{
    name = "Uzu";
    src = fetchTarball {
...
"P5opendir:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "P5opendir";
    src = fetchTarball {
...
"DB::Pg:ver<0.6>" = callPackage ({perl6-on-nix}:
{
    name = "DB::Pg";
    src = fetchTarball {
...
"App::Mi6:ver<0.2.5>" = callPackage ({perl6-on-nix}:
{
    name = "App::Mi6";
    src = fetchTarball {
...
"Async::Command:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Async::Command";
    src = fetchTarball {
...
"Cro::WebSocket:ver<0.7.4>" = callPackage ({perl6-on-nix}:
{
    name = "Cro::WebSocket";
    src = fetchTarball {
...
"Math::Polygons:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "Math::Polygons";
    src = fetchTarball {
...
"App::Game::Concentration:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
...
"AttrX::Mooish:ver<0.4.6>" = callPackage ({perl6-on-nix}:
{
    name = "AttrX::Mooish";
    src = fetchTarball {
...
"CPAN::Uploader::Tiny:ver<0.0.5>" = callPackage ({perl6-on-nix}:
{
...
"Algorithm::SetUnion:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
...
"File::Zip:ver<0.1.1>" = callPackage ({perl6-on-nix}:
{
    name = "File::Zip";
    src = fetchTarball {
...
"Algorithm::SkewHeap:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
...
"I18n::Simple:ver<0.1.2>" = callPackage ({perl6-on-nix}:
{
    name = "I18n::Simple";
    src = fetchTarball {
...
"JSON::Infer:ver<0.0.17>" = callPackage ({perl6-on-nix}:
{
    name = "JSON::Infer";
    src = fetchTarball {
...
"Test::HTTP::Server:ver<0.3.0>" = callPackage ({perl6-on-nix}:
{
...
"Gnome::Gtk3:ver<0.17.3>" = callPackage ({perl6-on-nix}:
{
    name = "Gnome::Gtk3";
    src = fetchTarball {
...
"Red:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Red";
    src = fetchTarball {
...
"OO::Plugin:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "OO::Plugin";
    src = fetchTarball {
...
"Hash::Merge:ver<0.2.1>" = callPackage ({perl6-on-nix}:
{
    name = "Hash::Merge";
    src = fetchTarball {
...
"Smack:ver<0.1.0>" = callPackage ({perl6-on-nix}:
{
    name = "Smack";
    src = fetchTarball {
...
"Inline::Perl5:ver<0.34>" = callPackage ({perl6-on-nix}:
{
    name = "Inline::Perl5";
    src = fetchTarball {
...
"Audio::Libshout:ver<0.0.11>" = callPackage ({perl6-on-nix}:
{
    name = "Audio::Libshout";
    src = fetchTarball {
...
"List::AllUtils:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "List::AllUtils";
    src = fetchTarball {
...
"Term::Form:ver<1.2.4>" = callPackage ({perl6-on-nix}:
{
    name = "Term::Form";
    src = fetchTarball {
...
"Hash::Timeout:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Hash::Timeout";
    src = fetchTarball {
...
"TCP::LowLevel:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "TCP::LowLevel";
    src = fetchTarball {
...
"Audio::Icecast:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Audio::Icecast";
    src = fetchTarball {
...
"Linux::Cpuinfo:ver<0.0.9>" = callPackage ({perl6-on-nix}:
{
    name = "Linux::Cpuinfo";
    src = fetchTarball {
...
"Sparrowdo:ver<0.0.39>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowdo";
    src = fetchTarball {
...
"HTTP::Supply:ver<0.3.4>" = callPackage ({perl6-on-nix}:
{
    name = "HTTP::Supply";
    src = fetchTarball {
...
"Canoe:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Canoe";
    src = fetchTarball {
...
"FileSystem::Parent:ver<0.1.0>" = callPackage ({perl6-on-nix}:
{
...
"ENIGMA::Machine:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "ENIGMA::Machine";
    src = fetchTarball {
...
"Dist::Helper:ver<0.19.2>" = callPackage ({perl6-on-nix}:
{
    name = "Dist::Helper";
    src = fetchTarball {
...
"Gnome::N:ver<0.13.5>" = callPackage ({perl6-on-nix}:
{
    name = "Gnome::N";
    src = fetchTarball {
...
"Digest::SHA256::Native:ver<0.03>" = callPackage ({perl6-on-nix}:
{
...
"Log::Syslog::Native:ver<0.0.9>" = callPackage ({perl6-on-nix}:
{
...
"ArrayHash:ver<0.4.1>" = callPackage ({perl6-on-nix}:
{
    name = "ArrayHash";
    src = fetchTarball {
...
"ArrayHash:ver<0.3>" = callPackage ({perl6-on-nix}:
{
    name = "ArrayHash";
    src = fetchTarball {
...
"P5readlink:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "P5readlink";
    src = fetchTarball {
...
"Concurrent::Queue:ver<1.1>" = callPackage ({perl6-on-nix}:
{
...
"Hash::Agnostic:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Hash::Agnostic";
    src = fetchTarball {
...
"Cro::HTTP:ver<0.7.6.1>" = callPackage ({perl6-on-nix}:
{
    name = "Cro::HTTP";
    src = fetchTarball {
...
"Hash::Restricted:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
...
"Algorithm::LibSVM:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
...
"Sparrowdo::VSTS::YAML::Build:ver<0.0.6>" = callPackage ({perl6-on-nix}:
{
...
"Net::LibIDN:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Net::LibIDN";
    src = fetchTarball {
...
"List::UtilsBy:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "List::UtilsBy";
    src = fetchTarball {
...
"Pod::Load:ver<0.5.2>" = callPackage ({perl6-on-nix}:
{
    name = "Pod::Load";
    src = fetchTarball {
...
"Linux::Fuser:ver<0.0.11>" = callPackage ({perl6-on-nix}:
{
    name = "Linux::Fuser";
    src = fetchTarball {
...
"Time::gmtime:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "Time::gmtime";
    src = fetchTarball {
...
"NativeHelpers::Callback:ver<0.1>" = callPackage ({perl6-on-nix}:
{
...
"Cro::ZeroMQ:ver<0.8.0>" = callPackage ({perl6-on-nix}:
{
    name = "Cro::ZeroMQ";
    src = fetchTarball {
...
"DOM::Tiny:ver<0.5.2>" = callPackage ({perl6-on-nix}:
{
    name = "DOM::Tiny";
    src = fetchTarball {
...
"Seq::Bounded:ver<1.0>" = callPackage ({perl6-on-nix}:
{
    name = "Seq::Bounded";
    src = fetchTarball {
...
"IO::Glob:ver<0.7.0>" = callPackage ({perl6-on-nix}:
{
    name = "IO::Glob";
    src = fetchTarball {
...
"ProcStats:ver<0.1.1>" = callPackage ({perl6-on-nix}:
{
    name = "ProcStats";
    src = fetchTarball {
...
"Chart::Gnuplot:ver<0.0.5>" = callPackage ({perl6-on-nix}:
{
    name = "Chart::Gnuplot";
    src = fetchTarball {
...
"Lumberjack:ver<0.0.8>" = callPackage ({perl6-on-nix}:
{
    name = "Lumberjack";
    src = fetchTarball {
...
"App::MoarVM::ConfprogCompiler:ver<0.0.6>" = callPackage ({perl6-on-nix}:
{
...
"CPAN::Uploader::Tiny:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "CPAN::Uploader::Tiny";
    src = fetchTarball {
...
"Game::Sudoku:ver<0.2.0>" = callPackage ({perl6-on-nix}:
{
    name = "Game::Sudoku";
    src = fetchTarball {
...
"IO::Glob:ver<0.5>" = callPackage ({perl6-on-nix}:
{
    name = "IO::Glob";
    src = fetchTarball {
...
"Test::HTTP::Server:ver<0.5.0>" = callPackage ({perl6-on-nix}:
{
    name = "Test::HTTP::Server";
    src = fetchTarball {
...
"Amazon::DynamoDB:ver<0.1>" = callPackage ({perl6-on-nix}:
{
...
"URL:ver<0.2.0>" = callPackage ({perl6-on-nix}:
{
    name = "URL";
    src = fetchTarball {
...
"Sparrowdo::VSTS::YAML::Artifact:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
...
"Getopt::Long:ver<0.1.0>" = callPackage ({perl6-on-nix}:
{
    name = "Getopt::Long";
    src = fetchTarball {
...
"Sparrowdo:ver<0.0.44>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowdo";
    src = fetchTarball {
...
"Sparrowdo::RemoteFile:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
...
"App::MPD::Notify:ver<0.1.0>" = callPackage ({perl6-on-nix}:
{
    name = "App::MPD::Notify";
    src = fetchTarball {
...
"Data::Selector:ver<v.1.01>" = callPackage ({perl6-on-nix}:
{
    name = "Data::Selector";
    src = fetchTarball {
...
"Gnome::Gdk3:ver<0.14.5>" = callPackage ({perl6-on-nix}:
{
    name = "Gnome::Gdk3";
    src = fetchTarball {
...
"AWS::Session:ver<0.3>" = callPackage ({perl6-on-nix}:
{
    name = "AWS::Session";
    src = fetchTarball {
...
"Sparrowdo::RemoteFile:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowdo::RemoteFile";
    src = fetchTarball {
...
"CucumisSextus:ver<0.1.1>" = callPackage ({perl6-on-nix}:
{
    name = "CucumisSextus";
    src = fetchTarball {
...
"Tomtit:ver<0.0.12>" = callPackage ({perl6-on-nix}:
{
    name = "Tomtit";
    src = fetchTarball {
...
"Acme::Cow:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Acme::Cow";
    src = fetchTarball {
...
"Perl6::Ecosystem:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
...
"Matrix::Bot:ver<0.1.0>" = callPackage ({perl6-on-nix}:
{
    name = "Matrix::Bot";
    src = fetchTarball {
...
"Readline:ver<0.1.2>" = callPackage ({perl6-on-nix}:
{
    name = "Readline";
    src = fetchTarball {
...
"Cro::WebSocket:ver<0.8.0>" = callPackage ({perl6-on-nix}:
{
    name = "Cro::WebSocket";
    src = fetchTarball {
...
"Algorithm::LBFGS:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
...
"IO::Path::Mode:ver<0.0.7>" = callPackage ({perl6-on-nix}:
{
    name = "IO::Path::Mode";
    src = fetchTarball {
...
"Trait::Env:ver<0.5.1>" = callPackage ({perl6-on-nix}:
{
    name = "Trait::Env";
    src = fetchTarball {
...
"JSON::Infer:ver<0.0.16>" = callPackage ({perl6-on-nix}:
{
    name = "JSON::Infer";
    src = fetchTarball {
...
"EuclideanRhythm:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
...
"Sparrowdo::VSTS::YAML::Cordova:ver<0.0.16>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowdo::VSTS::YAML::Cordova";
    src = fetchTarball {
...
"Oddmuse6:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Oddmuse6";
    src = fetchTarball {
...
"Acme::Meow:ver<0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Acme::Meow";
    src = fetchTarball {
...
"Cro::TLS:ver<0.7.6>" = callPackage ({perl6-on-nix}:
{
    name = "Cro::TLS";
    src = fetchTarball {
...
"App::Mi6:ver<0.1.8>" = callPackage ({perl6-on-nix}:
{
    name = "App::Mi6";
    src = fetchTarball {
...
"Tomtit:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Tomtit";
    src = fetchTarball {
...
"Term::Choose::Util:ver<1.2.9>" = callPackage ({perl6-on-nix}:
{
    name = "Term::Choose::Util";
    src = fetchTarball {
...
"Random::Choice:ver<0.0.6>" = callPackage ({perl6-on-nix}:
{
    name = "Random::Choice";
    src = fetchTarball {
...
"App::Mi6:ver<0.1.0>" = callPackage ({perl6-on-nix}:
{
    name = "App::Mi6";
    src = fetchTarball {
...
"Future:ver<0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Future";
    src = fetchTarball {
...
"Zodiac::Chinese:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Zodiac::Chinese";
    src = fetchTarball {
...
"LIVR:ver<2.1.0>" = callPackage ({perl6-on-nix}:
{
    name = "LIVR";
    src = fetchTarball {
...
"POFile:ver<0.7.1>" = callPackage ({perl6-on-nix}:
{
    name = "POFile";
    src = fetchTarball {
...
"Path::Router:ver<0.4.0>" = callPackage ({perl6-on-nix}:
{
    name = "Path::Router";
    src = fetchTarball {
...
"pack6:ver<0.1>" = callPackage ({perl6-on-nix}:
{
    name = "pack6";
    src = fetchTarball {
...
"Cofra:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Cofra";
    src = fetchTarball {
...
"IO::Socket::Async::SSL:ver<0.6.1>" = callPackage ({perl6-on-nix}:
{
...
"Unix::Groups:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "Unix::Groups";
    src = fetchTarball {
...
"Audio::Silan:ver<0.0.6>" = callPackage ({perl6-on-nix}:
{
    name = "Audio::Silan";
    src = fetchTarball {
...
"Random::Choice:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Random::Choice";
    src = fetchTarball {
...
"Bitcoin::RPC::Client:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
...
"Reaper::Control:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Reaper::Control";
    src = fetchTarball {
...
"P5getpwnam:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "P5getpwnam";
    src = fetchTarball {
...
"Crypt::CAST5:ver<0.1.0>" = callPackage ({perl6-on-nix}:
{
    name = "Crypt::CAST5";
    src = fetchTarball {
...
"P5getnetbyname:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "P5getnetbyname";
    src = fetchTarball {
...
"Sparrowdo::VSTS::YAML::Cordova:ver<0.0.14>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowdo::VSTS::YAML::Cordova";
    src = fetchTarball {
...
"MessagePack::Class:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
...
"DB::Migration::Simple:ver<1.0>" = callPackage ({perl6-on-nix}:
{
...
"AttrX::Mooish:ver<0.4.0>" = callPackage ({perl6-on-nix}:
{
    name = "AttrX::Mooish";
    src = fetchTarball {
...
"epoll:ver<0.3>" = callPackage ({perl6-on-nix}:
{
    name = "epoll";
    src = fetchTarball {
...
"TMap:ver<0.2.0>" = callPackage ({perl6-on-nix}:
{
    name = "TMap";
    src = fetchTarball {
...
"P5print:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "P5print";
    src = fetchTarball {
...
"Grammar::PrettyErrors:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
...
"Oddmuse6:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "Oddmuse6";
    src = fetchTarball {
...
"Hastebin:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "Hastebin";
    src = fetchTarball {
...
"Sparrowform:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowform";
    src = fetchTarball {
...
"Cache::Async:ver<0.1.3>" = callPackage ({perl6-on-nix}:
{
    name = "Cache::Async";
    src = fetchTarball {
...
"Memoize:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "Memoize";
    src = fetchTarball {
...
"Sub::Memoized:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Sub::Memoized";
    src = fetchTarball {
...
"Pod::Render:ver<0.7.7>" = callPackage ({perl6-on-nix}:
{
    name = "Pod::Render";
    src = fetchTarball {
...
"Sparrowform:ver<0.0.10>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowform";
    src = fetchTarball {
...
"Config:ver<2.1.0>" = callPackage ({perl6-on-nix}:
{
    name = "Config";
    src = fetchTarball {
...
"Hash-with:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Hash-with";
    src = fetchTarball {
...
"Dist::Helper:ver<0.19.0>" = callPackage ({perl6-on-nix}:
{
    name = "Dist::Helper";
    src = fetchTarball {
...
"TimeUnit:ver<0.1.2>" = callPackage ({perl6-on-nix}:
{
    name = "TimeUnit";
    src = fetchTarball {
...
"Path::Through:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Path::Through";
    src = fetchTarball {
...
"Sparrowdo::Azure::Web::Cert:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
...
"AttrX::Mooish:ver<0.6.2>" = callPackage ({perl6-on-nix}:
{
    name = "AttrX::Mooish";
    src = fetchTarball {
...
"LogP6-Writer-Journald:ver<1.3.1>" = callPackage ({perl6-on-nix}:
{
...
"Time::gmtime:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Time::gmtime";
    src = fetchTarball {
...
"P5readlink:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "P5readlink";
    src = fetchTarball {
...
"cro:ver<0.7.1>" = callPackage ({perl6-on-nix}:
{
    name = "cro";
    src = fetchTarball {
...
"Desktop::Notify::Progress:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
...
"Algorithm::NaiveBayes:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
...
"LibraryCheck:ver<0.0.8>" = callPackage ({perl6-on-nix}:
{
    name = "LibraryCheck";
    src = fetchTarball {
...
"Bailador:ver<0.0.17>" = callPackage ({perl6-on-nix}:
{
    name = "Bailador";
    src = fetchTarball {
...
"CCLog:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "CCLog";
    src = fetchTarball {
...
"FindBin:ver<0.4.2>" = callPackage ({perl6-on-nix}:
{
    name = "FindBin";
    src = fetchTarball {
...
"Sparrowdo::Cordova::OSx::Build:ver<0.0.7>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowdo::Cordova::OSx::Build";
    src = fetchTarball {
...
"Cofra:ver<0.1.1>" = callPackage ({perl6-on-nix}:
{
    name = "Cofra";
    src = fetchTarball {
...
"Config::Parser::toml:ver<1.0.1>" = callPackage ({perl6-on-nix}:
{
...
"XML::Actions:ver<0.3.2>" = callPackage ({perl6-on-nix}:
{
    name = "XML::Actions";
    src = fetchTarball {
...
"MeCab:ver<0.0.6>" = callPackage ({perl6-on-nix}:
{
    name = "MeCab";
    src = fetchTarball {
...
"DateTime::DST:ver<0.3>" = callPackage ({perl6-on-nix}:
{
    name = "DateTime::DST";
    src = fetchTarball {
...
"App::ModuleSnap:ver<0.0.11>" = callPackage ({perl6-on-nix}:
{
    name = "App::ModuleSnap";
    src = fetchTarball {
...
"Test::Declare:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Test::Declare";
    src = fetchTarball {
...
"P5fc:ver<0.0.5>" = callPackage ({perl6-on-nix}:
{
    name = "P5fc";
    src = fetchTarball {
...
"META6:ver<0.0.20>" = callPackage ({perl6-on-nix}:
{
    name = "META6";
    src = fetchTarball {
...
"URI::FetchFile:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "URI::FetchFile";
    src = fetchTarball {
...
"Cro::OpenAPI::RoutesFromDefinition:ver<1.0.0>" = callPackage ({perl6-on-nix}:
{
...
"Log::Timeline:ver<0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Log::Timeline";
    src = fetchTarball {
...
"Chart::Gnuplot:ver<0.0.8>" = callPackage ({perl6-on-nix}:
{
    name = "Chart::Gnuplot";
    src = fetchTarball {
...
"App::FindSource:ver<0.0.6>" = callPackage ({perl6-on-nix}:
{
    name = "App::FindSource";
    src = fetchTarball {
...
"Net::IP:ver<1.0.0>" = callPackage ({perl6-on-nix}:
{
    name = "Net::IP";
    src = fetchTarball {
...
"IP::Random:ver<0.0.10>" = callPackage ({perl6-on-nix}:
{
    name = "IP::Random";
    src = fetchTarball {
...
"App::Mi6:ver<0.1.3>" = callPackage ({perl6-on-nix}:
{
    name = "App::Mi6";
    src = fetchTarball {
...
"Sparky:ver<0.0.24>" = callPackage ({perl6-on-nix}:
{
    name = "Sparky";
    src = fetchTarball {
...
"P5built-ins:ver<0.0.21>" = callPackage ({perl6-on-nix}:
{
    name = "P5built-ins";
    src = fetchTarball {
...
"Decimal:ver<0.3.1>" = callPackage ({perl6-on-nix}:
{
    name = "Decimal";
    src = fetchTarball {
...
"Library:ver<0.13.4>" = callPackage ({perl6-on-nix}:
{
    name = "Library";
    src = fetchTarball {
...
"Backtrace::AsHTML:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
...
"Sparrowform:ver<0.0.11>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowform";
    src = fetchTarball {
...
"AttrX::Mooish:ver<0.4.4>" = callPackage ({perl6-on-nix}:
{
    name = "AttrX::Mooish";
    src = fetchTarball {
...
"GraphQL::Html:ver<0.7.0>" = callPackage ({perl6-on-nix}:
{
    name = "GraphQL::Html";
    src = fetchTarball {
...
"Oddmuse6:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Oddmuse6";
    src = fetchTarball {
...
"FindBin::libs:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "FindBin::libs";
    src = fetchTarball {
...
"App::Assixt:ver<0.1.0>" = callPackage ({perl6-on-nix}:
{
    name = "App::Assixt";
    src = fetchTarball {
...
"Sparrowdo:ver<0.1.0>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowdo";
    src = fetchTarball {
...
"Constants::Netinet::In:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
...
"Sparrowdo::Cordova::OSx::Build:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowdo::Cordova::OSx::Build";
    src = fetchTarball {
...
"SDL2::Raw:ver<0.1>" = callPackage ({perl6-on-nix}:
{
    name = "SDL2::Raw";
    src = fetchTarball {
...
"MeCab:ver<0.0.11>" = callPackage ({perl6-on-nix}:
{
    name = "MeCab";
    src = fetchTarball {
...
"List::AllUtils:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "List::AllUtils";
    src = fetchTarball {
...
"JSON::Fast:ver<0.9.11>" = callPackage ({perl6-on-nix}:
{
    name = "JSON::Fast";
    src = fetchTarball {
...
"Lumberjack::Dispatcher::Syslog:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
...
"Getopt::Long:ver<0.1.2>" = callPackage ({perl6-on-nix}:
{
    name = "Getopt::Long";
    src = fetchTarball {
...
"App::MoarVM::ConfprogCompiler:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "App::MoarVM::ConfprogCompiler";
    src = fetchTarball {
...
"cro:ver<0.7.2>" = callPackage ({perl6-on-nix}:
{
    name = "cro";
    src = fetchTarball {
...
"Proc::InvokeEditor:ver<0.0.6>" = callPackage ({perl6-on-nix}:
{
...
"Sparrowdo:ver<0.0.41>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowdo";
    src = fetchTarball {
...
"Chronic:ver<0.0.7>" = callPackage ({perl6-on-nix}:
{
    name = "Chronic";
    src = fetchTarball {
...
"IRC::Client::Plugin::NickServ:ver<0.1.1>" = callPackage ({perl6-on-nix}:
{
...
"Inline::Go:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "Inline::Go";
    src = fetchTarball {
...
"LogP6:ver<1.6.1>" = callPackage ({perl6-on-nix}:
{
    name = "LogP6";
    src = fetchTarball {
...
"HTTP::Headers:ver<0.1>" = callPackage ({perl6-on-nix}:
{
    name = "HTTP::Headers";
    src = fetchTarball {
...
"Config::Parser::json:ver<0.1.0>" = callPackage ({perl6-on-nix}:
{
...
"Object::Trampoline:ver<0.0.6>" = callPackage ({perl6-on-nix}:
{
...
"DB::MySQL:ver<0.5>" = callPackage ({perl6-on-nix}:
{
    name = "DB::MySQL";
    src = fetchTarball {
...
"BlkMeV:ver<0.2.0>" = callPackage ({perl6-on-nix}:
{
    name = "BlkMeV";
    src = fetchTarball {
...
"Result:ver<0.2.3>" = callPackage ({perl6-on-nix}:
{
    name = "Result";
    src = fetchTarball {
...
"Acme::Test::Module:ver<1.0.2>" = callPackage ({perl6-on-nix}:
{
...
"Array::Sparse:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Array::Sparse";
    src = fetchTarball {
...
"P5sleep:ver<0.0.7>" = callPackage ({perl6-on-nix}:
{
    name = "P5sleep";
    src = fetchTarball {
...
"XML::XPath:ver<0.9.3>" = callPackage ({perl6-on-nix}:
{
    name = "XML::XPath";
    src = fetchTarball {
...
"Test::SourceFiles:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
...
"Path::Finder:ver<0.2.0>" = callPackage ({perl6-on-nix}:
{
    name = "Path::Finder";
    src = fetchTarball {
...
"Podviewer:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Podviewer";
    src = fetchTarball {
...
"Font::FreeType:ver<0.1.8>" = callPackage ({perl6-on-nix}:
{
    name = "Font::FreeType";
    src = fetchTarball {
...
"HandleSupplier:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "HandleSupplier";
    src = fetchTarball {
...
"Test::Util::ServerPort:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
...
"Chart::Gnuplot:ver<0.0.6>" = callPackage ({perl6-on-nix}:
{
    name = "Chart::Gnuplot";
    src = fetchTarball {
...
"UNIX::Privileges:ver<0.1.2>" = callPackage ({perl6-on-nix}:
{
...
"TAP:ver<0.0.5>" = callPackage ({perl6-on-nix}:
{
    name = "TAP";
    src = fetchTarball {
...
"DirHandle:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "DirHandle";
    src = fetchTarball {
...
"P5__DATA__:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "P5__DATA__";
    src = fetchTarball {
...
"PKCS5:ver<v.0.1.6.2>" = callPackage ({perl6-on-nix}:
{
    name = "PKCS5";
    src = fetchTarball {
...
"Gnome::Gtk3:ver<0.17.5>" = callPackage ({perl6-on-nix}:
{
    name = "Gnome::Gtk3";
    src = fetchTarball {
...
"Perl6::Tidy:ver<y>" = callPackage ({perl6-on-nix}:
{
    name = "Perl6::Tidy";
    src = fetchTarball {
...
"Hash::Agnostic:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "Hash::Agnostic";
    src = fetchTarball {
...
"P5lc:ver<0.0.6>" = callPackage ({perl6-on-nix}:
{
    name = "P5lc";
    src = fetchTarball {
...
"Sparrowdo::VSTS::YAML::Cordova:ver<0.0.12>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowdo::VSTS::YAML::Cordova";
    src = fetchTarball {
...
"Cro::ZeroMQ:ver<0.7.3>" = callPackage ({perl6-on-nix}:
{
    name = "Cro::ZeroMQ";
    src = fetchTarball {
...
"File::XML::DMARC::Google:ver<0.1.1>" = callPackage ({perl6-on-nix}:
{
...
"Object::Delayed:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Object::Delayed";
    src = fetchTarball {
...
"FindBin::libs:ver<0.1.1>" = callPackage ({perl6-on-nix}:
{
    name = "FindBin::libs";
    src = fetchTarball {
...
"App::nm2perl6:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "App::nm2perl6";
    src = fetchTarball {
...
"Uzu:ver<0.3.2>" = callPackage ({perl6-on-nix}:
{
    name = "Uzu";
    src = fetchTarball {
...
"cro:ver<0.7.4>" = callPackage ({perl6-on-nix}:
{
    name = "cro";
    src = fetchTarball {
...
"MongoDB:ver<0.43.8>" = callPackage ({perl6-on-nix}:
{
    name = "MongoDB";
    src = fetchTarball {
...
"Cro::RPC::JSON:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "Cro::RPC::JSON";
    src = fetchTarball {
...
"Algorithm::LDA:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "Algorithm::LDA";
    src = fetchTarball {
...
"Proc::InvokeEditor:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Proc::InvokeEditor";
    src = fetchTarball {
...
"Gnome::Gtk3:ver<0.17.1>" = callPackage ({perl6-on-nix}:
{
    name = "Gnome::Gtk3";
    src = fetchTarball {
...
"Cro::Core:ver<0.8.0>" = callPackage ({perl6-on-nix}:
{
    name = "Cro::Core";
    src = fetchTarball {
...
"Red:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Red";
    src = fetchTarball {
...
"Object::Trampoline:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Object::Trampoline";
    src = fetchTarball {
...
"Term::Form:ver<1.2.5>" = callPackage ({perl6-on-nix}:
{
    name = "Term::Form";
    src = fetchTarball {
...
"P5chop:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "P5chop";
    src = fetchTarball {
...
"P6Repl::Helper:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "P6Repl::Helper";
    src = fetchTarball {
...
"LibCurl:ver<0.8>" = callPackage ({perl6-on-nix}:
{
    name = "LibCurl";
    src = fetchTarball {
...
"App::Mi6:ver<0.1.4>" = callPackage ({perl6-on-nix}:
{
    name = "App::Mi6";
    src = fetchTarball {
...
"I18N::LangTags:ver<0.1.0>" = callPackage ({perl6-on-nix}:
{
    name = "I18N::LangTags";
    src = fetchTarball {
...
"Trait::Env:ver<0.2.0>" = callPackage ({perl6-on-nix}:
{
    name = "Trait::Env";
    src = fetchTarball {
...
"FileSystem::Parent:ver<0.3.4>" = callPackage ({perl6-on-nix}:
{
    name = "FileSystem::Parent";
    src = fetchTarball {
...
"Algorithm::LDA:ver<0.0.8>" = callPackage ({perl6-on-nix}:
{
    name = "Algorithm::LDA";
    src = fetchTarball {
...
"Tie::Hash:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "Tie::Hash";
    src = fetchTarball {
...
"Ranker:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Ranker";
    src = fetchTarball {
...
"Inline::Perl5:ver<0.37>" = callPackage ({perl6-on-nix}:
{
    name = "Inline::Perl5";
    src = fetchTarball {
...
"Async::Workers:ver<0.0.6>" = callPackage ({perl6-on-nix}:
{
    name = "Async::Workers";
    src = fetchTarball {
...
"Color::Scheme:ver<1.001001>" = callPackage ({perl6-on-nix}:
{
    name = "Color::Scheme";
    src = fetchTarball {
...
"Test::HTTP::Server:ver<0.3.2>" = callPackage ({perl6-on-nix}:
{
    name = "Test::HTTP::Server";
    src = fetchTarball {
...
"DB:ver<0.3>" = callPackage ({perl6-on-nix}:
{
    name = "DB";
    src = fetchTarball {
...
"Proc::Editor:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Proc::Editor";
    src = fetchTarball {
...
"Algorithm::LDA:ver<0.0.5>" = callPackage ({perl6-on-nix}:
{
    name = "Algorithm::LDA";
    src = fetchTarball {
...
"Map::Agnostic:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Map::Agnostic";
    src = fetchTarball {
...
"Inline::Perl5:ver<0.35>" = callPackage ({perl6-on-nix}:
{
    name = "Inline::Perl5";
    src = fetchTarball {
...
"Algorithm::LibSVM:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "Algorithm::LibSVM";
    src = fetchTarball {
...
"Hash::Merge:ver<1.0.0>" = callPackage ({perl6-on-nix}:
{
    name = "Hash::Merge";
    src = fetchTarball {
...
"Algorithm::Manacher:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
...
"Date::Calendar::FrenchRevolutionary:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
...
"Algorithm::LDA:ver<0.0.6>" = callPackage ({perl6-on-nix}:
{
    name = "Algorithm::LDA";
    src = fetchTarball {
...
"ScaleVec:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "ScaleVec";
    src = fetchTarball {
...
"JSON::Fast:ver<0.9.15>" = callPackage ({perl6-on-nix}:
{
    name = "JSON::Fast";
    src = fetchTarball {
...
"I18n::Simple:ver<0.1.0>" = callPackage ({perl6-on-nix}:
{
    name = "I18n::Simple";
    src = fetchTarball {
...
"DBIx::NamedQueries:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
...
"IO::Glob:ver<v.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "IO::Glob";
    src = fetchTarball {
...
"DB::Pg:ver<0.3>" = callPackage ({perl6-on-nix}:
{
    name = "DB::Pg";
    src = fetchTarball {
...
"App::Mi6:ver<0.2.6>" = callPackage ({perl6-on-nix}:
{
    name = "App::Mi6";
    src = fetchTarball {
...
"Git::Log:ver<0.1.2>" = callPackage ({perl6-on-nix}:
{
    name = "Git::Log";
    src = fetchTarball {
...
"Sparrowdo:ver<0.0.38>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowdo";
    src = fetchTarball {
...
"AttrX::Mooish:ver<0.4.8>" = callPackage ({perl6-on-nix}:
{
    name = "AttrX::Mooish";
    src = fetchTarball {
...
"Cro::Core:ver<0.7.4>" = callPackage ({perl6-on-nix}:
{
    name = "Cro::Core";
    src = fetchTarball {
...
"Hash::LRU:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Hash::LRU";
    src = fetchTarball {
...
"Sparrowdo:ver<0.0.45>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowdo";
    src = fetchTarball {
...
"Algorithm::GooglePolylineEncoding:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
...
"Scheduler::DelayBetween:ver<1.3.1>" = callPackage ({perl6-on-nix}:
{
...
"App::Platform:ver<0.2.1>" = callPackage ({perl6-on-nix}:
{
    name = "App::Platform";
    src = fetchTarball {
...
"Test::HTTP::Server:ver<0.3.1>" = callPackage ({perl6-on-nix}:
{
    name = "Test::HTTP::Server";
    src = fetchTarball {
...
"Time::gmtime:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Time::gmtime";
    src = fetchTarball {
...
"JSON::Fast:ver<0.9.17>" = callPackage ({perl6-on-nix}:
{
    name = "JSON::Fast";
    src = fetchTarball {
...
"DB::MySQL:ver<0.3>" = callPackage ({perl6-on-nix}:
{
    name = "DB::MySQL";
    src = fetchTarball {
...
"Perl6::Parser:ver<0.2.1>" = callPackage ({perl6-on-nix}:
{
    name = "Perl6::Parser";
    src = fetchTarball {
...
"App::Mi6:ver<0.2.0>" = callPackage ({perl6-on-nix}:
{
    name = "App::Mi6";
    src = fetchTarball {
...
"P5getpriority:ver<0.0.5>" = callPackage ({perl6-on-nix}:
{
    name = "P5getpriority";
    src = fetchTarball {
...
"Map::Agnostic:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Map::Agnostic";
    src = fetchTarball {
...
"Readline:ver<0.1.4>" = callPackage ({perl6-on-nix}:
{
    name = "Readline";
    src = fetchTarball {
...
"P5defined:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "P5defined";
    src = fetchTarball {
...
"Cro::WebApp:ver<0.8.1>" = callPackage ({perl6-on-nix}:
{
    name = "Cro::WebApp";
    src = fetchTarball {
...
"App::Perl6LangServer:ver<0.2.0>" = callPackage ({perl6-on-nix}:
{
...
"AttrX::Mooish:ver<0.2.2>" = callPackage ({perl6-on-nix}:
{
    name = "AttrX::Mooish";
    src = fetchTarball {
...
"Trait::Env:ver<0.2.1>" = callPackage ({perl6-on-nix}:
{
    name = "Trait::Env";
    src = fetchTarball {
...
"Music::Engine:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Music::Engine";
    src = fetchTarball {
...
"AttrX::Mooish:ver<0.2.5>" = callPackage ({perl6-on-nix}:
{
    name = "AttrX::Mooish";
    src = fetchTarball {
...
"ProcStats:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "ProcStats";
    src = fetchTarball {
...
"Sparrowdo::VSTS::YAML::Build:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowdo::VSTS::YAML::Build";
    src = fetchTarball {
...
"DirHandle:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "DirHandle";
    src = fetchTarball {
...
"App::Platform:ver<0.3>" = callPackage ({perl6-on-nix}:
{
    name = "App::Platform";
    src = fetchTarball {
...
"Font::FreeType:ver<0.1.9>" = callPackage ({perl6-on-nix}:
{
    name = "Font::FreeType";
    src = fetchTarball {
...
"AttrX::Mooish:ver<0.4.12>" = callPackage ({perl6-on-nix}:
{
    name = "AttrX::Mooish";
    src = fetchTarball {
...
"Algorithm::AhoCorasick:ver<0.0.8>" = callPackage ({perl6-on-nix}:
{
...
"OpenAPI::Model:ver<1.0>" = callPackage ({perl6-on-nix}:
{
    name = "OpenAPI::Model";
    src = fetchTarball {
...
"XML::Class:ver<0.0.6>" = callPackage ({perl6-on-nix}:
{
    name = "XML::Class";
    src = fetchTarball {
...
"Tuple:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Tuple";
    src = fetchTarball {
...
"Hash::Util:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Hash::Util";
    src = fetchTarball {
...
"P5opendir:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "P5opendir";
    src = fetchTarball {
...
"Gnome::Gtk3:ver<0.17.0>" = callPackage ({perl6-on-nix}:
{
    name = "Gnome::Gtk3";
    src = fetchTarball {
...
"FindBin:ver<0.4.0>" = callPackage ({perl6-on-nix}:
{
    name = "FindBin";
    src = fetchTarball {
...
"Color::Names:ver<1.001003>" = callPackage ({perl6-on-nix}:
{
    name = "Color::Names";
    src = fetchTarball {
...
"Object::Trampoline:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "Object::Trampoline";
    src = fetchTarball {
...
"HTTP::Request::FormData:ver<0.2>" = callPackage ({perl6-on-nix}:
{
...
"Tomtit:ver<0.0.24>" = callPackage ({perl6-on-nix}:
{
    name = "Tomtit";
    src = fetchTarball {
...
"JSON::Path:ver<1.2>" = callPackage ({perl6-on-nix}:
{
    name = "JSON::Path";
    src = fetchTarball {
...
"Acme::Don't:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Acme::Don't";
    src = fetchTarball {
...
"Libclang:ver<0.2.0>" = callPackage ({perl6-on-nix}:
{
    name = "Libclang";
    src = fetchTarball {
...
"XML::Class:ver<0.0.7>" = callPackage ({perl6-on-nix}:
{
    name = "XML::Class";
    src = fetchTarball {
...
"P5rindex:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "P5rindex";
    src = fetchTarball {
...
"Sparrowform:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowform";
    src = fetchTarball {
...
"DB:ver<0.1>" = callPackage ({perl6-on-nix}:
{
    name = "DB";
    src = fetchTarball {
...
"App::Mi6:ver<0.2.1>" = callPackage ({perl6-on-nix}:
{
    name = "App::Mi6";
    src = fetchTarball {
...
"JSON::Hjson:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "JSON::Hjson";
    src = fetchTarball {
...
"P5localtime:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "P5localtime";
    src = fetchTarball {
...
"Config:ver<1.3.2>" = callPackage ({perl6-on-nix}:
{
    name = "Config";
    src = fetchTarball {
...
"ULID:ver<0.1.0>" = callPackage ({perl6-on-nix}:
{
    name = "ULID";
    src = fetchTarball {
...
"App::Assixt:ver<0.1.1>" = callPackage ({perl6-on-nix}:
{
    name = "App::Assixt";
    src = fetchTarball {
...
"Tinky:ver<0.0.7>" = callPackage ({perl6-on-nix}:
{
    name = "Tinky";
    src = fetchTarball {
...
"LibUUID:ver<0.5>" = callPackage ({perl6-on-nix}:
{
    name = "LibUUID";
    src = fetchTarball {
...
"Grammar::PrettyErrors:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Grammar::PrettyErrors";
    src = fetchTarball {
...
"HTTP::Headers:ver<0.3.0>" = callPackage ({perl6-on-nix}:
{
    name = "HTTP::Headers";
    src = fetchTarball {
...
"File::Metadata::Libextractor:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
...
"Scalar::Util:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "Scalar::Util";
    src = fetchTarball {
...
"WebService::Discourse:ver<0.1.0>" = callPackage ({perl6-on-nix}:
{
...
"Bailador:ver<0.0.16>" = callPackage ({perl6-on-nix}:
{
    name = "Bailador";
    src = fetchTarball {
...
"IRC::Client::Plugin::UrlTitle:ver<1.1.1>" = callPackage ({perl6-on-nix}:
{
    name = "IRC::Client::Plugin::UrlTitle";
    src = fetchTarball {
...
"Cro::HTTP:ver<0.7.6>" = callPackage ({perl6-on-nix}:
{
    name = "Cro::HTTP";
    src = fetchTarball {
...
"Perl6::Ecosystem:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Perl6::Ecosystem";
    src = fetchTarball {
...
"P5times:ver<0.0.5>" = callPackage ({perl6-on-nix}:
{
    name = "P5times";
    src = fetchTarball {
...
"Podviewer:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Podviewer";
    src = fetchTarball {
...
"MongoDB:ver<0.43.3>" = callPackage ({perl6-on-nix}:
{
    name = "MongoDB";
    src = fetchTarball {
...
"Readline:ver<0.1.1>" = callPackage ({perl6-on-nix}:
{
    name = "Readline";
    src = fetchTarball {
...
"Tomtit:ver<0.0.7>" = callPackage ({perl6-on-nix}:
{
    name = "Tomtit";
    src = fetchTarball {
...
"String::Fold:ver<0.1.2>" = callPackage ({perl6-on-nix}:
{
    name = "String::Fold";
    src = fetchTarball {
...
"GraphQL:ver<0.5.8>" = callPackage ({perl6-on-nix}:
{
    name = "GraphQL";
    src = fetchTarball {
...
"Tika:ver<0.1.0>" = callPackage ({perl6-on-nix}:
{
    name = "Tika";
    src = fetchTarball {
...
"Geo::Ellipsoid:ver<1.0.0>" = callPackage ({perl6-on-nix}:
{
    name = "Geo::Ellipsoid";
    src = fetchzip {
...
"Cro::TLS:ver<0.7.3>" = callPackage ({perl6-on-nix}:
{
    name = "Cro::TLS";
    src = fetchTarball {
...
"JSON::Marshal:ver<0.0.16>" = callPackage ({perl6-on-nix}:
{
    name = "JSON::Marshal";
    src = fetchTarball {
...
"Result:ver<0.2.4>" = callPackage ({perl6-on-nix}:
{
    name = "Result";
    src = fetchTarball {
...
"JSON::Path:ver<1.1>" = callPackage ({perl6-on-nix}:
{
    name = "JSON::Path";
    src = fetchTarball {
...
"Sparrowdo::VSTS::YAML::Angular::Build:ver<0.0.5>" = callPackage ({perl6-on-nix}:
{
...
"CheckSocket:ver<0.0.5>" = callPackage ({perl6-on-nix}:
{
    name = "CheckSocket";
    src = fetchTarball {
...
"Pod::Load:ver<0.3.1>" = callPackage ({perl6-on-nix}:
{
    name = "Pod::Load";
    src = fetchTarball {
...
"Text::BorderedBlock:ver<0.1.0>" = callPackage ({perl6-on-nix}:
{
...
"Git::Log:ver<0.2.0>" = callPackage ({perl6-on-nix}:
{
    name = "Git::Log";
    src = fetchTarball {
...
"XML::XPath:ver<0.9.2>" = callPackage ({perl6-on-nix}:
{
    name = "XML::XPath";
    src = fetchTarball {
...
"Sparrowdo:ver<0.0.35>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowdo";
    src = fetchTarball {
...
"Structable:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Structable";
    src = fetchTarball {
...
"Date::Names:ver<2.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Date::Names";
    src = fetchTarball {
...
"HTML::Canvas::To::PDF:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
...
"App::Mi6:ver<0.1.5>" = callPackage ({perl6-on-nix}:
{
    name = "App::Mi6";
    src = fetchTarball {
...
"Lingua::Stem::Es:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Lingua::Stem::Es";
    src = fetchTarball {
...
"List::MoreUtils:ver<0.0.5>" = callPackage ({perl6-on-nix}:
{
    name = "List::MoreUtils";
    src = fetchTarball {
...
"cro:ver<0.7.5>" = callPackage ({perl6-on-nix}:
{
    name = "cro";
    src = fetchTarball {
...
"Object::Delayed:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Object::Delayed";
    src = fetchTarball {
...
"FastCGI::NativeCall:ver<0.0.6>" = callPackage ({perl6-on-nix}:
{
...
"Sparrowform:ver<0.0.14>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowform";
    src = fetchTarball {
...
"Sys::Utmp:ver<0.0.12>" = callPackage ({perl6-on-nix}:
{
    name = "Sys::Utmp";
    src = fetchTarball {
...
"META6:ver<0.0.22>" = callPackage ({perl6-on-nix}:
{
    name = "META6";
    src = fetchTarball {
...
"META6::To::Man:ver<0.2.0>" = callPackage ({perl6-on-nix}:
{
    name = "META6::To::Man";
    src = fetchTarball {
...
"Env:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Env";
    src = fetchTarball {
...
"JSON::Path:ver<0.1>" = callPackage ({perl6-on-nix}:
{
    name = "JSON::Path";
    src = fetchTarball {
...
"Config:ver<1.3.4>" = callPackage ({perl6-on-nix}:
{
    name = "Config";
    src = fetchTarball {
...
"Async::Workers:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "Async::Workers";
    src = fetchTarball {
...
"App::Assixt:ver<0.4.0>" = callPackage ({perl6-on-nix}:
{
    name = "App::Assixt";
    src = fetchTarball {
...
"AttrX::Mooish:ver<0.6.0>" = callPackage ({perl6-on-nix}:
{
    name = "AttrX::Mooish";
    src = fetchTarball {
...
"Sparrowdo::Cordova::OSx::Build:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowdo::Cordova::OSx::Build";
    src = fetchTarball {
...
"Lingua::Stopwords:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
...
"OAuth2::Client::Google:ver<0.1.0>" = callPackage ({perl6-on-nix}:
{
...
"Acme::Cow6:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Acme::Cow6";
    src = fetchTarball {
...
"P6Repl::Helper:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "P6Repl::Helper";
    src = fetchTarball {
...
"Sparrowdo::Azure::Web::Cert:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowdo::Azure::Web::Cert";
    src = fetchTarball {
...
"Algorithm::NaiveBayes:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Algorithm::NaiveBayes";
    src = fetchTarball {
...
"App::Platform:ver<0.1.0>" = callPackage ({perl6-on-nix}:
{
    name = "App::Platform";
    src = fetchTarball {
...
"App::Mi6:ver<0.1.9>" = callPackage ({perl6-on-nix}:
{
    name = "App::Mi6";
    src = fetchTarball {
...
"HTTP::Supply:ver<0.3.2>" = callPackage ({perl6-on-nix}:
{
    name = "HTTP::Supply";
    src = fetchTarball {
...
"FileSystem::Parent:ver<0.3.2>" = callPackage ({perl6-on-nix}:
{
    name = "FileSystem::Parent";
    src = fetchTarball {
...
"Gnome::GObject:ver<0.13.11>" = callPackage ({perl6-on-nix}:
{
    name = "Gnome::GObject";
    src = fetchTarball {
...
"AttrX::Mooish:ver<0.1.0>" = callPackage ({perl6-on-nix}:
{
    name = "AttrX::Mooish";
    src = fetchTarball {
...
"Magento:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Magento";
    src = fetchTarball {
...
"Proc::InvokeEditor:ver<0.0.5>" = callPackage ({perl6-on-nix}:
{
    name = "Proc::InvokeEditor";
    src = fetchTarball {
...
"Gnome::Gdk3:ver<0.14.6>" = callPackage ({perl6-on-nix}:
{
    name = "Gnome::Gdk3";
    src = fetchTarball {
...
"CroX::HTTP::Transform::GraphQL:ver<0.1>" = callPackage ({perl6-on-nix}:
{
...
"IP::Addr:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "IP::Addr";
    src = fetchTarball {
...
"Net::protoent:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Net::protoent";
    src = fetchTarball {
...
"P5reverse:ver<0.0.5>" = callPackage ({perl6-on-nix}:
{
    name = "P5reverse";
    src = fetchTarball {
...
"Pod::Load:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Pod::Load";
    src = fetchTarball {
...
"App::Assixt:ver<1.0.0>" = callPackage ({perl6-on-nix}:
{
    name = "App::Assixt";
    src = fetchTarball {
...
"Audio::Silan:ver<0.0.5>" = callPackage ({perl6-on-nix}:
{
    name = "Audio::Silan";
    src = fetchTarball {
...
"Algorithm::LDA:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Algorithm::LDA";
    src = fetchTarball {
...
"PowerNap:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "PowerNap";
    src = fetchTarball {
...
"Verge::RPC::Client:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
...
"User::grent:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "User::grent";
    src = fetchTarball {
...
"Text::CSV:ver<0.008>" = callPackage ({perl6-on-nix}:
{
    name = "Text::CSV";
    src = fetchTarball {
...
"Proc::InvokeEditor:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Proc::InvokeEditor";
    src = fetchTarball {
...
"Algorithm::GooglePolylineEncoding:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "Algorithm::GooglePolylineEncoding";
    src = fetchTarball {
...
"App::Assixt:ver<0.3.0>" = callPackage ({perl6-on-nix}:
{
    name = "App::Assixt";
    src = fetchTarball {
...
"Desktop::Notify:ver<0.3.2>" = callPackage ({perl6-on-nix}:
{
    name = "Desktop::Notify";
    src = fetchTarball {
...
"Game::Sudoku:ver<1.1.0>" = callPackage ({perl6-on-nix}:
{
    name = "Game::Sudoku";
    src = fetchTarball {
...
"HTTP::Tinyish:ver<0.1.4>" = callPackage ({perl6-on-nix}:
{
    name = "HTTP::Tinyish";
    src = fetchTarball {
...
"AttrX::Mooish:ver<0.4.3>" = callPackage ({perl6-on-nix}:
{
    name = "AttrX::Mooish";
    src = fetchTarball {
...
"TAP:ver<0.0.8>" = callPackage ({perl6-on-nix}:
{
    name = "TAP";
    src = fetchTarball {
...
"Map::Ordered:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Map::Ordered";
    src = fetchTarball {
...
"Template::Anti:ver<0.5.0>" = callPackage ({perl6-on-nix}:
{
    name = "Template::Anti";
    src = fetchTarball {
...
"Terminal::Getpass:ver<0.0.5>" = callPackage ({perl6-on-nix}:
{
...
"App::Mi6:ver<0.0.6>" = callPackage ({perl6-on-nix}:
{
    name = "App::Mi6";
    src = fetchTarball {
...
"Lingua::Pangram:ver<0.1.1>" = callPackage ({perl6-on-nix}:
{
    name = "Lingua::Pangram";
    src = fetchTarball {
...
"Object::Permission:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
...
"AccountableBagHash:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
...
"Config:ver<1.2.2>" = callPackage ({perl6-on-nix}:
{
    name = "Config";
    src = fetchTarball {
...
"ProcStats:ver<0.1.2>" = callPackage ({perl6-on-nix}:
{
    name = "ProcStats";
    src = fetchTarball {
...
"Hash::Restricted:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Hash::Restricted";
    src = fetchTarball {
...
"Device::Velleman::K8055:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
...
"Cro::Core:ver<0.7.1>" = callPackage ({perl6-on-nix}:
{
    name = "Cro::Core";
    src = fetchTarball {
...
"SQL::Lexer:ver<0.1.1>" = callPackage ({perl6-on-nix}:
{
    name = "SQL::Lexer";
    src = fetchTarball {
...
"Cro::H:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Cro::H";
    src = fetchTarball {
...
"Test::Performance:ver<0.2.1>" = callPackage ({perl6-on-nix}:
{
...
"Red:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Red";
    src = fetchTarball {
...
"Proc::Editor:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Proc::Editor";
    src = fetchTarball {
...
"Tomtit:ver<0.0.14>" = callPackage ({perl6-on-nix}:
{
    name = "Tomtit";
    src = fetchTarball {
...
"US-ASCII:ver<0.6.4>" = callPackage ({perl6-on-nix}:
{
    name = "US-ASCII";
    src = fetchTarball {
...
"Tomtit:ver<0.0.10>" = callPackage ({perl6-on-nix}:
{
    name = "Tomtit";
    src = fetchTarball {
...
"App::nm2perl6:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "App::nm2perl6";
    src = fetchTarball {
...
"Sparrowdo::VSTS::YAML::Build::Assembly::Patch:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowdo::VSTS::YAML::Build::Assembly::Patch";
    src = fetchTarball {
...
"LogP6:ver<1.5.1>" = callPackage ({perl6-on-nix}:
{
    name = "LogP6";
    src = fetchTarball {
...
"DB::MySQL:ver<0.1>" = callPackage ({perl6-on-nix}:
{
    name = "DB::MySQL";
    src = fetchTarball {
...
"App::Assixt:ver<0.1.4>" = callPackage ({perl6-on-nix}:
{
    name = "App::Assixt";
    src = fetchTarball {
...
"ANTLR4::Grammar:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "ANTLR4::Grammar";
    src = fetchTarball {
...
"Net::LibIDN2:ver<0.1.0>" = callPackage ({perl6-on-nix}:
{
    name = "Net::LibIDN2";
    src = fetchTarball {
...
"HTTP::Tinyish:ver<0.1.2>" = callPackage ({perl6-on-nix}:
{
    name = "HTTP::Tinyish";
    src = fetchTarball {
...
"Sparrowdo::VSTS::YAML::Cordova:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowdo::VSTS::YAML::Cordova";
    src = fetchTarball {
...
"CamelPub:ver<0.2.6>" = callPackage ({perl6-on-nix}:
{
    name = "CamelPub";
    src = fetchTarball {
...
"Igo:ver<0.0.5>" = callPackage ({perl6-on-nix}:
{
    name = "Igo";
    src = fetchTarball {
...
"Semaphore::ReadersWriters:ver<0.2.6.1>" = callPackage ({perl6-on-nix}:
{
...
"Propius:ver<0.1.1>" = callPackage ({perl6-on-nix}:
{
    name = "Propius";
    src = fetchTarball {
...
"GraphQL:ver<0.6.1>" = callPackage ({perl6-on-nix}:
{
    name = "GraphQL";
    src = fetchTarball {
...
"IO::Socket::Async::SSL:ver<0.7.1>" = callPackage ({perl6-on-nix}:
{
    name = "IO::Socket::Async::SSL";
    src = fetchTarball {
...
"Log::Syslog::Native:ver<0.0.8>" = callPackage ({perl6-on-nix}:
{
    name = "Log::Syslog::Native";
    src = fetchTarball {
...
"Inline:ver<v.1.2>" = callPackage ({perl6-on-nix}:
{
    name = "Inline";
    src = fetchTarball {
...
"Lingua::Stopwords:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Lingua::Stopwords";
    src = fetchTarball {
...
"Cro::RPC::JSON:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Cro::RPC::JSON";
    src = fetchTarball {
...
"Lumberjack:ver<0.0.7>" = callPackage ({perl6-on-nix}:
{
    name = "Lumberjack";
    src = fetchTarball {
...
"Gnome::Gtk3:ver<0.17.7>" = callPackage ({perl6-on-nix}:
{
    name = "Gnome::Gtk3";
    src = fetchTarball {
...
"IO::Glob:ver<0.8.0>" = callPackage ({perl6-on-nix}:
{
    name = "IO::Glob";
    src = fetchTarball {
...
"JSON::Marshal:ver<0.0.17>" = callPackage ({perl6-on-nix}:
{
    name = "JSON::Marshal";
    src = fetchTarball {
...
"FindBin:ver<0.3.4>" = callPackage ({perl6-on-nix}:
{
    name = "FindBin";
    src = fetchTarball {
...
"DB::Pg:ver<0.4>" = callPackage ({perl6-on-nix}:
{
    name = "DB::Pg";
    src = fetchTarball {
...
"P5tie:ver<0.0.10>" = callPackage ({perl6-on-nix}:
{
    name = "P5tie";
    src = fetchTarball {
...
"Text::Sift4:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Text::Sift4";
    src = fetchTarball {
...
"Algorithm::LDA:ver<0.0.9>" = callPackage ({perl6-on-nix}:
{
    name = "Algorithm::LDA";
    src = fetchTarball {
...
"Bailador:ver<0.0.18>" = callPackage ({perl6-on-nix}:
{
    name = "Bailador";
    src = fetchTarball {
...
"P5quotemeta:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "P5quotemeta";
    src = fetchTarball {
...
"AttrX::Mooish:ver<0.2.6>" = callPackage ({perl6-on-nix}:
{
    name = "AttrX::Mooish";
    src = fetchTarball {
...
"IRC::Client::Plugin::UrlTitle:ver<1.1.2>" = callPackage ({perl6-on-nix}:
{
    name = "IRC::Client::Plugin::UrlTitle";
    src = fetchTarball {
...
"Uzu:ver<0.2.6>" = callPackage ({perl6-on-nix}:
{
    name = "Uzu";
    src = fetchTarball {
...
"Text::More:ver<0.1.8>" = callPackage ({perl6-on-nix}:
{
    name = "Text::More";
    src = fetchTarball {
...
"App::nm2perl6:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "App::nm2perl6";
    src = fetchTarball {
...
"Concurrent::Stack:ver<1.1>" = callPackage ({perl6-on-nix}:
{
...
"Test::META:ver<0.0.16>" = callPackage ({perl6-on-nix}:
{
    name = "Test::META";
    src = fetchTarball {
...
"Path::Router:ver<0.3.0>" = callPackage ({perl6-on-nix}:
{
    name = "Path::Router";
    src = fetchTarball {
...
"Monitor::Monit:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Monitor::Monit";
    src = fetchTarball {
...
"App::Platform:ver<0.4.2>" = callPackage ({perl6-on-nix}:
{
    name = "App::Platform";
    src = fetchTarball {
        url = "https://www.cpan.org/authors/id/K/KA/KAJI/Perl6/App-Platform-0.4.3.tar.gz";
        sha256 = "1p7k8nm3lyz3xfchms3a1xa8p630j8n1rrjxch82rxa4k5ywx1d1";
    };
    depends = [
        perl6-on-nix.libraries."Text::Wrap"
        perl6-on-nix.libraries."YAMLish"
...
"P5getprotobyname:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
...
"Sparrowdo::VSTS::YAML::Cordova:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowdo::VSTS::YAML::Cordova";
    src = fetchTarball {
...
"Getopt::Advance:ver<1.1.4>" = callPackage ({perl6-on-nix}:
{
    name = "Getopt::Advance";
    src = fetchTarball {
...
"IRC::Client::Plugin::UrlTitle:ver<1.1.0>" = callPackage ({perl6-on-nix}:
{
    name = "IRC::Client::Plugin::UrlTitle";
    src = fetchTarball {
...
"JSON::Fast:ver<0.9.10>" = callPackage ({perl6-on-nix}:
{
    name = "JSON::Fast";
    src = fetchTarball {
...
"JSON::Fast:ver<0.9.7>" = callPackage ({perl6-on-nix}:
{
    name = "JSON::Fast";
    src = fetchTarball {
...
"Gnome::Gdk3:ver<0.14.7>" = callPackage ({perl6-on-nix}:
{
    name = "Gnome::Gdk3";
    src = fetchTarball {
...
"ANTLR4::Grammar:ver<0.1.0>" = callPackage ({perl6-on-nix}:
{
    name = "ANTLR4::Grammar";
    src = fetchTarball {
...
"IRC::Client::Plugin::UrlTitle:ver<1.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "IRC::Client::Plugin::UrlTitle";
    src = fetchTarball {
...
"SDL2::Raw:ver<0.3>" = callPackage ({perl6-on-nix}:
{
    name = "SDL2::Raw";
    src = fetchTarball {
...
"Pod::To::HTMLBody:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
...
"AWS::Session:ver<0.7>" = callPackage ({perl6-on-nix}:
{
    name = "AWS::Session";
    src = fetchTarball {
...
"IConv:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "IConv";
    src = fetchTarball {
...
"LibCurl:ver<0.6.1>" = callPackage ({perl6-on-nix}:
{
    name = "LibCurl";
    src = fetchTarball {
...
"InterceptAllMethods:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
...
"PDF::Font::Loader:ver<0.2.4>" = callPackage ({perl6-on-nix}:
{
...
"Igo:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "Igo";
    src = fetchTarball {
...
"Ops::SI:ver<0.1.0>" = callPackage ({perl6-on-nix}:
{
    name = "Ops::SI";
    src = fetchTarball {
...
"Sparky:ver<0.0.22>" = callPackage ({perl6-on-nix}:
{
    name = "Sparky";
    src = fetchTarball {
...
"Archive::Libarchive:ver<0.0.13>" = callPackage ({perl6-on-nix}:
{
...
"Sparrowdo::VSTS::YAML::Cordova:ver<0.0.17>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowdo::VSTS::YAML::Cordova";
    src = fetchTarball {
...
"Uzu:ver<0.2.5>" = callPackage ({perl6-on-nix}:
{
    name = "Uzu";
    src = fetchTarball {
...
"P5getservbyname:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
...
"App::CPAN:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "App::CPAN";
    src = fetchTarball {
...
"Perl6::Tidy:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Perl6::Tidy";
    src = fetchTarball {
...
"FindBin:ver<0.3.3>" = callPackage ({perl6-on-nix}:
{
    name = "FindBin";
    src = fetchTarball {
...
"AWS::Session:ver<0.5>" = callPackage ({perl6-on-nix}:
{
    name = "AWS::Session";
    src = fetchTarball {
...
"epoll:ver<0.1>" = callPackage ({perl6-on-nix}:
{
    name = "epoll";
    src = fetchTarball {
...
"AWS::Session:ver<0.1>" = callPackage ({perl6-on-nix}:
{
    name = "AWS::Session";
    src = fetchTarball {
...
"JSON::Path:ver<1.6>" = callPackage ({perl6-on-nix}:
{
    name = "JSON::Path";
    src = fetchTarball {
...
"CPAN::Uploader::Tiny:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "CPAN::Uploader::Tiny";
    src = fetchTarball {
...
"PDF::Class:ver<0.3.7>" = callPackage ({perl6-on-nix}:
{
    name = "PDF::Class";
    src = fetchTarball {
...
"HTTP::Supply:ver<0.3.5>" = callPackage ({perl6-on-nix}:
{
    name = "HTTP::Supply";
    src = fetchTarball {
...
"DOM::Tiny:ver<0.5.1>" = callPackage ({perl6-on-nix}:
{
    name = "DOM::Tiny";
    src = fetchTarball {
...
"Async::Workers:ver<0.0.5>" = callPackage ({perl6-on-nix}:
{
    name = "Async::Workers";
    src = fetchTarball {
...
"Sparrowform:ver<0.0.6>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowform";
    src = fetchTarball {
...
"P5getservbyname:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "P5getservbyname";
    src = fetchTarball {
...
"Cache::Async:ver<0.1.6>" = callPackage ({perl6-on-nix}:
{
    name = "Cache::Async";
    src = fetchTarball {
...
"Math::Curves:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Math::Curves";
    src = fetchTarball {
...
"Trait::Env:ver<0.1.0>" = callPackage ({perl6-on-nix}:
{
    name = "Trait::Env";
    src = fetchTarball {
...
"Tomtit:ver<0.0.15>" = callPackage ({perl6-on-nix}:
{
    name = "Tomtit";
    src = fetchTarball {
...
"Hash-with:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Hash-with";
    src = fetchTarball {
...
"Algorithm::Heap::Binary:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
...
"Graphics::TinyTIFF:ver<0.0.5>" = callPackage ({perl6-on-nix}:
{
...
"SQL::NamedPlaceholder:ver<0.1.0>" = callPackage ({perl6-on-nix}:
{
...
"IRC::Client::Plugin::Github:ver<0.1.4>" = callPackage ({perl6-on-nix}:
{
...
"HTTP::Headers:ver<0.4.0>" = callPackage ({perl6-on-nix}:
{
    name = "HTTP::Headers";
    src = fetchTarball {
...
"IP::Addr:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "IP::Addr";
    src = fetchTarball {
...
"IoC:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "IoC";
    src = fetchTarball {
...
"LibCurl:ver<0.5.3>" = callPackage ({perl6-on-nix}:
{
    name = "LibCurl";
    src = fetchTarball {
...
"TMap:ver<0.1.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "TMap";
    src = fetchTarball {
...
"Trait::Env:ver<0.3.2>" = callPackage ({perl6-on-nix}:
{
    name = "Trait::Env";
    src = fetchTarball {
...
"TAP::Harness:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "TAP::Harness";
    src = fetchTarball {
...
"JSON::Marshal:ver<0.0.18>" = callPackage ({perl6-on-nix}:
{
    name = "JSON::Marshal";
    src = fetchTarball {
...
"Sparrow6:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrow6";
    src = fetchTarball {
...
"Cro::RPC::JSON:ver<0.0.5>" = callPackage ({perl6-on-nix}:
{
    name = "Cro::RPC::JSON";
    src = fetchTarball {
...
"Cro::HTTP:ver<0.7.3>" = callPackage ({perl6-on-nix}:
{
    name = "Cro::HTTP";
    src = fetchTarball {
...
"Smack:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Smack";
    src = fetchTarball {
...
"Object::Delayed:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Object::Delayed";
    src = fetchTarball {
...
"App::MoarVM::ConfprogCompiler:ver<0.0.7>" = callPackage ({perl6-on-nix}:
{
    name = "App::MoarVM::ConfprogCompiler";
    src = fetchTarball {
...
"Getopt::ForClass:ver<0.2>" = callPackage ({perl6-on-nix}:
{
...
"Test::Color:ver<1.001002>" = callPackage ({perl6-on-nix}:
{
    name = "Test::Color";
    src = fetchTarball {
...
"IO::Glob:ver<0.6>" = callPackage ({perl6-on-nix}:
{
    name = "IO::Glob";
    src = fetchTarball {
...
"Array::Agnostic:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "Array::Agnostic";
    src = fetchTarball {
...
"Geo::Coordinates::UTM:ver<0.9.0>" = callPackage ({perl6-on-nix}:
{
...
"P5chdir:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "P5chdir";
    src = fetchTarball {
...
"ModelDB:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "ModelDB";
    src = fetchTarball {
...
"Tomtit:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Tomtit";
    src = fetchTarball {
...
"IO::Socket::Async::SSL:ver<0.7.0>" = callPackage ({perl6-on-nix}:
{
    name = "IO::Socket::Async::SSL";
    src = fetchTarball {
...
"IoC:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "IoC";
    src = fetchTarball {
...
"CamelPub:ver<0.2.5>" = callPackage ({perl6-on-nix}:
{
    name = "CamelPub";
    src = fetchTarball {
...
"FindBin::libs:ver<0.2.0>" = callPackage ({perl6-on-nix}:
{
    name = "FindBin::libs";
    src = fetchTarball {
...
"Inline::Perl5:ver<0.33>" = callPackage ({perl6-on-nix}:
{
    name = "Inline::Perl5";
    src = fetchTarball {
...
"Date::Names:ver<1.1.0>" = callPackage ({perl6-on-nix}:
{
    name = "Date::Names";
    src = fetchTarball {
...
"AttrX::Mooish:ver<0.4.13>" = callPackage ({perl6-on-nix}:
{
    name = "AttrX::Mooish";
    src = fetchTarball {
...
"Cro::ZeroMQ:ver<0.7.6>" = callPackage ({perl6-on-nix}:
{
    name = "Cro::ZeroMQ";
    src = fetchTarball {
...
"Sparrowdo::VSTS::YAML::Cordova:ver<0.0.13>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowdo::VSTS::YAML::Cordova";
    src = fetchTarball {
...
"Gnome::Gtk3:ver<0.17.9>" = callPackage ({perl6-on-nix}:
{
    name = "Gnome::Gtk3";
    src = fetchTarball {
...
"Dist::Helper:ver<0.21.1>" = callPackage ({perl6-on-nix}:
{
    name = "Dist::Helper";
    src = fetchTarball {
...
"Chart::Gnuplot:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Chart::Gnuplot";
    src = fetchTarball {
...
"pack6:ver<0.2>" = callPackage ({perl6-on-nix}:
{
    name = "pack6";
    src = fetchTarball {
...
"Algorithm::Evolutionary::Simple:ver<0.0.5>" = callPackage ({perl6-on-nix}:
{
...
"Log::Timeline:ver<0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Log::Timeline";
    src = fetchTarball {
...
"Array::Agnostic:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Array::Agnostic";
    src = fetchTarball {
...
"Sparrowdo::VSTS::YAML::Solution:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
...
"P5chdir:ver<0.0.5>" = callPackage ({perl6-on-nix}:
{
    name = "P5chdir";
    src = fetchTarball {
...
"Chart::Gnuplot:ver<0.0.11>" = callPackage ({perl6-on-nix}:
{
    name = "Chart::Gnuplot";
    src = fetchTarball {
...
"Bailador:ver<0.0.15>" = callPackage ({perl6-on-nix}:
{
    name = "Bailador";
    src = fetchTarball {
...
"Async::Workers:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Async::Workers";
    src = fetchTarball {
...
"Term::TablePrint:ver<1.5.0>" = callPackage ({perl6-on-nix}:
{
...
"Term::ReadKey:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Term::ReadKey";
    src = fetchTarball {
...
"AttrX::Mooish:ver<0.4.7>" = callPackage ({perl6-on-nix}:
{
    name = "AttrX::Mooish";
    src = fetchTarball {
...
"Readline:ver<0.1.5>" = callPackage ({perl6-on-nix}:
{
    name = "Readline";
    src = fetchTarball {
...
"US-ASCII:ver<0.6.6>" = callPackage ({perl6-on-nix}:
{
    name = "US-ASCII";
    src = fetchTarball {
...
"AWS::Session:ver<0.4>" = callPackage ({perl6-on-nix}:
{
    name = "AWS::Session";
    src = fetchTarball {
...
"HTML::Canvas:ver<0.0.7>" = callPackage ({perl6-on-nix}:
{
    name = "HTML::Canvas";
    src = fetchTarball {
...
"Sparrowform:ver<0.0.12>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowform";
    src = fetchTarball {
...
"SemiXML:ver<v.0.48.1>" = callPackage ({perl6-on-nix}:
{
    name = "SemiXML";
    src = fetchTarball {
...
"P5each:ver<0.0.5>" = callPackage ({perl6-on-nix}:
{
    name = "P5each";
    src = fetchTarball {
...
"Grammar::ErrorReporting:ver<0.2>" = callPackage ({perl6-on-nix}:
{
...
"DOM::Tiny:ver<0.4.1>" = callPackage ({perl6-on-nix}:
{
    name = "DOM::Tiny";
    src = fetchTarball {
...
"Net::BGP:ver<0.1.2>" = callPackage ({perl6-on-nix}:
{
    name = "Net::BGP";
    src = fetchTarball {
...
"Concurrent::Stack:ver<1.0>" = callPackage ({perl6-on-nix}:
{
    name = "Concurrent::Stack";
    src = fetchTarball {
...
"Hash::Merge:ver<0.2.0>" = callPackage ({perl6-on-nix}:
{
    name = "Hash::Merge";
    src = fetchTarball {
...
"Reaper::Control:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Reaper::Control";
    src = fetchTarball {
...
"AttrX::Mooish:ver<0.2.0>" = callPackage ({perl6-on-nix}:
{
    name = "AttrX::Mooish";
    src = fetchTarball {
...
"P5seek:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "P5seek";
    src = fetchTarball {
...
"ANTLR4::Grammar:ver<0.5.2>" = callPackage ({perl6-on-nix}:
{
    name = "ANTLR4::Grammar";
    src = fetchTarball {
...
"Pod::Load:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Pod::Load";
    src = fetchTarball {
...
"Sparrowdo::Cordova::OSx::Fortify:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
...
"Sparrowdo::VSTS::YAML::Nuget::Build:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
...
"Sparrow6:ver<0.0.7>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrow6";
    src = fetchTarball {
...
"FileSystem::Parent:ver<0.3.1>" = callPackage ({perl6-on-nix}:
{
    name = "FileSystem::Parent";
    src = fetchTarball {
...
"Test::HTTP::Server:ver<0.1.0>" = callPackage ({perl6-on-nix}:
{
    name = "Test::HTTP::Server";
    src = fetchTarball {
...
"Sparrowdo::VSTS::YAML::Update::Azure::SSL:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
...
"List::UtilsBy:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "List::UtilsBy";
    src = fetchTarball {
...
"Gnome::Glib:ver<0.13.3>" = callPackage ({perl6-on-nix}:
{
    name = "Gnome::Glib";
    src = fetchTarball {
...
"Cro::Core:ver<0.8.1>" = callPackage ({perl6-on-nix}:
{
    name = "Cro::Core";
    src = fetchTarball {
...
"HTML::Canvas::To::PDF:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "HTML::Canvas::To::PDF";
    src = fetchTarball {
...
"Git::Log:ver<0.1.1>" = callPackage ({perl6-on-nix}:
{
    name = "Git::Log";
    src = fetchTarball {
...
"Tomtit:ver<0.0.11>" = callPackage ({perl6-on-nix}:
{
    name = "Tomtit";
    src = fetchTarball {
...
"Test::Color:ver<1.001001>" = callPackage ({perl6-on-nix}:
{
    name = "Test::Color";
    src = fetchTarball {
...
"Lumberjack::Application:ver<0.0.7>" = callPackage ({perl6-on-nix}:
{
...
"AttrX::Mooish:ver<0.2.3>" = callPackage ({perl6-on-nix}:
{
    name = "AttrX::Mooish";
    src = fetchTarball {
...
"IO::Path::Dirstack:ver<0.1.1>" = callPackage ({perl6-on-nix}:
{
...
"Sparky::Plugin::Notify::Email:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
...
"Sparrowdo::VSTS::YAML::DotNet:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
...
"Hash::MultiValue:ver<0.5>" = callPackage ({perl6-on-nix}:
{
...
"HTTP::Supply:ver<0.3.1>" = callPackage ({perl6-on-nix}:
{
    name = "HTTP::Supply";
    src = fetchTarball {
...
"Log::Timeline:ver<0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Log::Timeline";
    src = fetchTarball {
...
"Acme::Cow:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "Acme::Cow";
    src = fetchTarball {
...
"Array::Agnostic:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Array::Agnostic";
    src = fetchTarball {
...
"Pod::Load:ver<0.2.0>" = callPackage ({perl6-on-nix}:
{
    name = "Pod::Load";
    src = fetchTarball {
...
"Game::Sudoku:ver<1.0.0>" = callPackage ({perl6-on-nix}:
{
    name = "Game::Sudoku";
    src = fetchTarball {
...
"Trait::Env:ver<0.3.1>" = callPackage ({perl6-on-nix}:
{
    name = "Trait::Env";
    src = fetchTarball {
...
"FastCGI::NativeCall::Async:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
...
"AttrX::Mooish:ver<0.4.11>" = callPackage ({perl6-on-nix}:
{
    name = "AttrX::Mooish";
    src = fetchTarball {
...
"Email::Address:ver<0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Email::Address";
    src = fetchTarball {
...
"Tomtit:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Tomtit";
    src = fetchTarball {
...
"Sparrowdo::VSTS::YAML::Build::Assembly::Patch:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowdo::VSTS::YAML::Build::Assembly::Patch";
    src = fetchTarball {
...
"Inline::Perl5:ver<0.38>" = callPackage ({perl6-on-nix}:
{
    name = "Inline::Perl5";
    src = fetchTarball {
...
"Geo::Coder::OpenCage:ver<1.0>" = callPackage ({perl6-on-nix}:
{
...
"Text::Sift4:ver<0.0.5>" = callPackage ({perl6-on-nix}:
{
    name = "Text::Sift4";
    src = fetchTarball {
...
"Net::Telnet:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Net::Telnet";
    src = fetchTarball {
...
"Terminal::Getpass:ver<0.0.6>" = callPackage ({perl6-on-nix}:
{
    name = "Terminal::Getpass";
    src = fetchTarball {
...
"Archive::SimpleZip:ver<0.2.3>" = callPackage ({perl6-on-nix}:
{
...
"Unicode::PRECIS:ver<v.0.5.1.1>" = callPackage ({perl6-on-nix}:
{
    name = "Unicode::PRECIS";
    src = fetchTarball {
...
"Dist::Helper:ver<0.21.0>" = callPackage ({perl6-on-nix}:
{
    name = "Dist::Helper";
    src = fetchTarball {
...
"Time::localtime:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Time::localtime";
    src = fetchTarball {
...
"Sparky::Plugin::Notify::Telegram:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
...
"P5ucfirst:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "P5ucfirst";
    src = fetchTarball {
...
"Font::FreeType:ver<0.1.7>" = callPackage ({perl6-on-nix}:
{
    name = "Font::FreeType";
    src = fetchTarball {
...
"Pg::Notify:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Pg::Notify";
    src = fetchTarball {
...
"Ops::SI:ver<0.1.1>" = callPackage ({perl6-on-nix}:
{
    name = "Ops::SI";
    src = fetchTarball {
...
"Constants::Sys::Socket:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
...
"BitEnum:ver<0.1>" = callPackage ({perl6-on-nix}:
{
    name = "BitEnum";
    src = fetchTarball {
...
"Archive::SimpleZip:ver<0.1.2>" = callPackage ({perl6-on-nix}:
{
    name = "Archive::SimpleZip";
    src = fetchTarball {
...
"Term::Form:ver<1.2.3>" = callPackage ({perl6-on-nix}:
{
    name = "Term::Form";
    src = fetchTarball {
...
"ANTLR4::Grammar:ver<0.6.2>" = callPackage ({perl6-on-nix}:
{
    name = "ANTLR4::Grammar";
    src = fetchTarball {
...
"Hash::MultiValue:ver<0.6>" = callPackage ({perl6-on-nix}:
{
    name = "Hash::MultiValue";
    src = fetchTarball {
...
"unprint:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "unprint";
    src = fetchTarball {
...
"Hash::Merge:ver<0.1.1>" = callPackage ({perl6-on-nix}:
{
    name = "Hash::Merge";
    src = fetchTarball {
...
"P6Repl::Helper:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "P6Repl::Helper";
    src = fetchTarball {
...
"Graphics::TinyTIFF:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Graphics::TinyTIFF";
    src = fetchTarball {
...
"P5push:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "P5push";
    src = fetchTarball {
...
"EventSource::Server:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
...
"Algorithm::LDA:ver<0.0.7>" = callPackage ({perl6-on-nix}:
{
    name = "Algorithm::LDA";
    src = fetchTarball {
...
"Sparrowdo::VSTS::YAML::Cordova:ver<0.0.11>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowdo::VSTS::YAML::Cordova";
    src = fetchTarball {
...
"Object::Permission::Group:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
...
"Date::Calendar::FrenchRevolutionary:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Date::Calendar::FrenchRevolutionary";
    src = fetchTarball {
...
"App::Mi6:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "App::Mi6";
    src = fetchTarball {
...
"FileSystem::Parent:ver<0.3.0>" = callPackage ({perl6-on-nix}:
{
    name = "FileSystem::Parent";
    src = fetchTarball {
...
"Game::Sudoku:ver<1.1.1>" = callPackage ({perl6-on-nix}:
{
    name = "Game::Sudoku";
    src = fetchTarball {
...
"Tomtit:ver<0.0.13>" = callPackage ({perl6-on-nix}:
{
    name = "Tomtit";
    src = fetchTarball {
...
"DB::Pg:ver<0.5>" = callPackage ({perl6-on-nix}:
{
    name = "DB::Pg";
    src = fetchTarball {
...
"ProcStats:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "ProcStats";
    src = fetchTarball {
...
"Chart::Gnuplot:ver<0.0.7>" = callPackage ({perl6-on-nix}:
{
    name = "Chart::Gnuplot";
    src = fetchTarball {
...
"Wkhtmltox:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Wkhtmltox";
    src = fetchTarball {
...
"ANTLR4::Grammar:ver<0.5.0>" = callPackage ({perl6-on-nix}:
{
    name = "ANTLR4::Grammar";
    src = fetchTarball {
...
"epoll:ver<0.2>" = callPackage ({perl6-on-nix}:
{
    name = "epoll";
    src = fetchTarball {
...
"ANTLR4::Grammar:ver<0.6.0>" = callPackage ({perl6-on-nix}:
{
    name = "ANTLR4::Grammar";
    src = fetchTarball {
...
"Compress::Zstd:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Compress::Zstd";
    src = fetchTarball {
...
"IO::Blob:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "IO::Blob";
    src = fetchTarball {
...
"Sparrow6:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrow6";
    src = fetchTarball {
...
"RPi::Device::PiGlow:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
...
"Gnome::GObject:ver<0.13.13>" = callPackage ({perl6-on-nix}:
{
    name = "Gnome::GObject";
    src = fetchTarball {
...
"Getopt::Long:ver<0.1.1>" = callPackage ({perl6-on-nix}:
{
    name = "Getopt::Long";
    src = fetchTarball {
...
"Array::Sparse:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Array::Sparse";
    src = fetchTarball {
...
"IO::Path::Dirstack:ver<0.1.0>" = callPackage ({perl6-on-nix}:
{
    name = "IO::Path::Dirstack";
    src = fetchTarball {
...
"Bits:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Bits";
    src = fetchTarball {
...
"Template::Anti:ver<0.5.2>" = callPackage ({perl6-on-nix}:
{
    name = "Template::Anti";
    src = fetchTarball {
...
"P5getpwnam:ver<0.0.5>" = callPackage ({perl6-on-nix}:
{
    name = "P5getpwnam";
    src = fetchTarball {
...
"GraphQL::Server:ver<0.1>" = callPackage ({perl6-on-nix}:
{
    name = "GraphQL::Server";
    src = fetchTarball {
...
"Method::Also:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Method::Also";
    src = fetchTarball {
...
"AttrX::Mooish:ver<0.4.10>" = callPackage ({perl6-on-nix}:
{
    name = "AttrX::Mooish";
    src = fetchTarball {
...
"Sparrowdo::VSTS::YAML::Nuget:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
...
"StrictClass:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "StrictClass";
    src = fetchTarball {
...
"Text::Sift4:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Text::Sift4";
    src = fetchTarball {
...
"P5caller:ver<0.0.6>" = callPackage ({perl6-on-nix}:
{
    name = "P5caller";
    src = fetchTarball {
...
"ANTLR4::Grammar:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "ANTLR4::Grammar";
    src = fetchTarball {
...
"P5each:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "P5each";
    src = fetchTarball {
...
"Acme::Test::Module:ver<1.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Acme::Test::Module";
    src = fetchTarball {
...
"Config:ver<2.0.0>" = callPackage ({perl6-on-nix}:
{
    name = "Config";
    src = fetchTarball {
...
"Algorithm::Evolutionary::Simple:ver<0.0.3.1>" = callPackage ({perl6-on-nix}:
{
    name = "Algorithm::Evolutionary::Simple";
    src = fetchTarball {
...
"JSON::Pointer:ver<1.0>" = callPackage ({perl6-on-nix}:
{
    name = "JSON::Pointer";
    src = fetchTarball {
...
"RPi::Device::ST7036:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
...
"Config::DataLang::Refine:ver<0.7.3>" = callPackage ({perl6-on-nix}:
{
...
"Perl6::Tidy:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Perl6::Tidy";
    src = fetchTarball {
...
"AttrX::Mooish:ver<0.6.1>" = callPackage ({perl6-on-nix}:
{
    name = "AttrX::Mooish";
    src = fetchTarball {
...
"Cro::WebSocket:ver<0.8.1>" = callPackage ({perl6-on-nix}:
{
    name = "Cro::WebSocket";
    src = fetchTarball {
...
"Async::Workers:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Async::Workers";
    src = fetchTarball {
...
"Cro::ZeroMQ:ver<0.7.1>" = callPackage ({perl6-on-nix}:
{
    name = "Cro::ZeroMQ";
    src = fetchTarball {
...
"Terminal::Spinners:ver<1.1.0>" = callPackage ({perl6-on-nix}:
{
...
"App::MoarVM::ConfprogCompiler:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "App::MoarVM::ConfprogCompiler";
    src = fetchTarball {
...
"LibUUID:ver<0.3>" = callPackage ({perl6-on-nix}:
{
    name = "LibUUID";
    src = fetchTarball {
...
"Array::Agnostic:ver<0.0.5>" = callPackage ({perl6-on-nix}:
{
    name = "Array::Agnostic";
    src = fetchTarball {
...
"AttrX::Mooish:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "AttrX::Mooish";
    src = fetchTarball {
...
"Gnome::Gtk3::Glade:ver<0.8.5>" = callPackage ({perl6-on-nix}:
{
...
"Readline:ver<0.1.0>" = callPackage ({perl6-on-nix}:
{
    name = "Readline";
    src = fetchTarball {
...
"Gnome::Gtk3:ver<0.17.2>" = callPackage ({perl6-on-nix}:
{
    name = "Gnome::Gtk3";
    src = fetchTarball {
...
"GDBM:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "GDBM";
    src = fetchTarball {
...
"Math::RungeKutta:ver<0.1>" = callPackage ({perl6-on-nix}:
{
...
"Sparrowform:ver<0.0.5>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowform";
    src = fetchTarball {
...
"JSON::Class:ver<0.0.13>" = callPackage ({perl6-on-nix}:
{
    name = "JSON::Class";
    src = fetchTarball {
...
"App::Prove6:ver<0.0.10>" = callPackage ({perl6-on-nix}:
{
    name = "App::Prove6";
    src = fetchTarball {
...
"Bits:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Bits";
    src = fetchTarball {
...
"App::MPD::AutoQueue:ver<0.1.0>" = callPackage ({perl6-on-nix}:
{
...
"Range::SetOps:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Range::SetOps";
    src = fetchTarball {
...
"POFile:ver<0.7>" = callPackage ({perl6-on-nix}:
{
    name = "POFile";
    src = fetchTarball {
...
"Staticish:ver<0.0.7>" = callPackage ({perl6-on-nix}:
{
    name = "Staticish";
    src = fetchTarball {
...
"Config:ver<1.3.0>" = callPackage ({perl6-on-nix}:
{
    name = "Config";
    src = fetchTarball {
...
"Data::Selector:ver<v.1.02>" = callPackage ({perl6-on-nix}:
{
    name = "Data::Selector";
    src = fetchTarball {
...
"Config:ver<1.3.3>" = callPackage ({perl6-on-nix}:
{
    name = "Config";
    src = fetchTarball {
...
"Neo4j:ver<0.1.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Neo4j";
    src = fetchTarball {
...
"Failable:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Failable";
    src = fetchTarball {
...
"Dist::Helper:ver<0.21.2>" = callPackage ({perl6-on-nix}:
{
    name = "Dist::Helper";
    src = fetchTarball {
...
"Router::Boost:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Router::Boost";
    src = fetchTarball {
...
"Gnome::Gtk3:ver<0.17.6>" = callPackage ({perl6-on-nix}:
{
    name = "Gnome::Gtk3";
    src = fetchTarball {
...
"XDG::BaseDirectory:ver<0.0.10>" = callPackage ({perl6-on-nix}:
{
...
"Sparrow6:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrow6";
    src = fetchTarball {
...
"App::MoarVM::ConfprogCompiler:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "App::MoarVM::ConfprogCompiler";
    src = fetchTarball {
...
"Terminal::Spinners:ver<1.2.0>" = callPackage ({perl6-on-nix}:
{
    name = "Terminal::Spinners";
    src = fetchTarball {
...
"App::Prove6:ver<0.0.9>" = callPackage ({perl6-on-nix}:
{
    name = "App::Prove6";
    src = fetchTarball {
...
"Sparrowdo::VSTS::YAML::Solution:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowdo::VSTS::YAML::Solution";
    src = fetchTarball {
...
"Tomtit:ver<0.0.28>" = callPackage ({perl6-on-nix}:
{
    name = "Tomtit";
    src = fetchTarball {
...
"Sparrowdo::VSTS::YAML::Nuget::Build:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowdo::VSTS::YAML::Nuget::Build";
    src = fetchTarball {
...
"Acme::Insult::Lala:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
...
"OpenAPI::Schema::Validate:ver<1.0>" = callPackage ({perl6-on-nix}:
{
    name = "OpenAPI::Schema::Validate";
    src = fetchTarball {
...
"Oyatul:ver<0.0.6>" = callPackage ({perl6-on-nix}:
{
    name = "Oyatul";
    src = fetchTarball {
...
"Random::Choice:ver<0.0.5>" = callPackage ({perl6-on-nix}:
{
    name = "Random::Choice";
    src = fetchTarball {
...
"SQL::Lexer:ver<0.2.2>" = callPackage ({perl6-on-nix}:
{
    name = "SQL::Lexer";
    src = fetchTarball {
...
"Numeric::Nearest:ver<0.5.0>" = callPackage ({perl6-on-nix}:
{
    name = "Numeric::Nearest";
    src = fetchTarball {
...
"WebService::AWS::S3:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
...
"CheckSocket:ver<0.0.6>" = callPackage ({perl6-on-nix}:
{
    name = "CheckSocket";
    src = fetchTarball {
...
"Igo:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Igo";
    src = fetchTarball {
...
"PDF::Font::Loader:ver<0.2.5>" = callPackage ({perl6-on-nix}:
{
    name = "PDF::Font::Loader";
    src = fetchTarball {
...
"Sparrowform:ver<0.0.13>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowform";
    src = fetchTarball {
...
"Rdf:ver<0.3.3.1>" = callPackage ({perl6-on-nix}:
{
    name = "Rdf";
    src = fetchTarball {
...
"XDG::BaseDirectory:ver<0.0.11>" = callPackage ({perl6-on-nix}:
{
    name = "XDG::BaseDirectory";
    src = fetchTarball {
...
"Sparrowdo::VSTS::YAML::Cordova:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowdo::VSTS::YAML::Cordova";
    src = fetchTarball {
...
"LibUUID:ver<0.2>" = callPackage ({perl6-on-nix}:
{
    name = "LibUUID";
    src = fetchTarball {
...
"RDF::Turtle:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "RDF::Turtle";
    src = fetchTarball {
...
"SQL::NamedPlaceholder:ver<0.1.1>" = callPackage ({perl6-on-nix}:
{
    name = "SQL::NamedPlaceholder";
    src = fetchTarball {
...
"zef:ver<0.1.15>" = callPackage ({perl6-on-nix}:
{
    name = "zef";
    src = fetchTarball {
...
"DB::SQLite:ver<0.1>" = callPackage ({perl6-on-nix}:
{
    name = "DB::SQLite";
    src = fetchTarball {
...
"Algorithm::LBFGS:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Algorithm::LBFGS";
    src = fetchTarball {
...
"Time::localtime:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Time::localtime";
    src = fetchTarball {
...
"Cro::HTTP::Session::Red:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
...
"DB::SQLite:ver<0.3>" = callPackage ({perl6-on-nix}:
{
    name = "DB::SQLite";
    src = fetchTarball {
...
"Cro::Core:ver<0.7.5>" = callPackage ({perl6-on-nix}:
{
    name = "Cro::Core";
    src = fetchTarball {
...
"Algorithm::HierarchicalPAM:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
...
"UEncoding:ver<0.1.0>" = callPackage ({perl6-on-nix}:
{
    name = "UEncoding";
    src = fetchTarball {
...
"ProcStats:ver<0.2.1>" = callPackage ({perl6-on-nix}:
{
    name = "ProcStats";
    src = fetchTarball {
...
"Operator::Listcat:ver<1.0.0>" = callPackage ({perl6-on-nix}:
{
...
"Algorithm::LibSVM:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Algorithm::LibSVM";
    src = fetchTarball {
...
"Gnome::GObject:ver<0.13.9>" = callPackage ({perl6-on-nix}:
{
    name = "Gnome::GObject";
    src = fetchTarball {
...
"MeCab:ver<0.0.13>" = callPackage ({perl6-on-nix}:
{
    name = "MeCab";
    src = fetchTarball {
...
"Hash::Restricted:ver<0.0.5>" = callPackage ({perl6-on-nix}:
{
    name = "Hash::Restricted";
    src = fetchTarball {
...
"Pod::Load:ver<0.5.5>" = callPackage ({perl6-on-nix}:
{
    name = "Pod::Load";
    src = fetchTarball {
...
"CamelPub:ver<0.1.0>" = callPackage ({perl6-on-nix}:
{
    name = "CamelPub";
    src = fetchTarball {
...
"AWS::Session:ver<0.8.0>" = callPackage ({perl6-on-nix}:
{
    name = "AWS::Session";
    src = fetchTarball {
...
"RPi::Device::SMBus:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
...
"P5getprotobyname:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "P5getprotobyname";
    src = fetchTarball {
...
"Game::Sudoku:ver<1.1.2>" = callPackage ({perl6-on-nix}:
{
    name = "Game::Sudoku";
    src = fetchTarball {
...
"NativeHelpers::Array:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
...
"Slang::Predicate:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
...
"Perl6::Tidy:ver<0.0.6>" = callPackage ({perl6-on-nix}:
{
    name = "Perl6::Tidy";
    src = fetchTarball {
...
"Amazon::DynamoDB:ver<0.4.0>" = callPackage ({perl6-on-nix}:
{
    name = "Amazon::DynamoDB";
    src = fetchTarball {
...
"cro:ver<0.7.6>" = callPackage ({perl6-on-nix}:
{
    name = "cro";
    src = fetchTarball {
...
"FindBin:ver<0.4.1>" = callPackage ({perl6-on-nix}:
{
    name = "FindBin";
    src = fetchTarball {
...
"App::AizuOnlineJudge:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
...
"Tie::Array:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "Tie::Array";
    src = fetchTarball {
...
"CamelPub:ver<0.2.0>" = callPackage ({perl6-on-nix}:
{
    name = "CamelPub";
    src = fetchTarball {
...
"Cro::Core:ver<0.7.6>" = callPackage ({perl6-on-nix}:
{
    name = "Cro::Core";
    src = fetchTarball {
...
"Audio::Hydrogen:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "Audio::Hydrogen";
    src = fetchTarball {
...
"Game::Sudoku:ver<0.1.0>" = callPackage ({perl6-on-nix}:
{
    name = "Game::Sudoku";
    src = fetchTarball {
...
"Net::NNG:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Net::NNG";
    src = fetchTarball {
...
"Tomtit:ver<0.0.21>" = callPackage ({perl6-on-nix}:
{
    name = "Tomtit";
    src = fetchTarball {
...
"Sparrowdo::VSTS::YAML::Build:ver<0.0.5>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowdo::VSTS::YAML::Build";
    src = fetchTarball {
...
"Tuple:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "Tuple";
    src = fetchTarball {
...
"MQ::Posix:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "MQ::Posix";
    src = fetchTarball {
...
"Gnome::Gtk3:ver<0.17.4>" = callPackage ({perl6-on-nix}:
{
    name = "Gnome::Gtk3";
    src = fetchTarball {
...
"Monitor::Monit:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Monitor::Monit";
    src = fetchTarball {
...
"Pod::Load:ver<0.5.0>" = callPackage ({perl6-on-nix}:
{
    name = "Pod::Load";
    src = fetchTarball {
...
"AccountableBagHash:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "AccountableBagHash";
    src = fetchTarball {
...
"Test::Performance:ver<0.2.0>" = callPackage ({perl6-on-nix}:
{
    name = "Test::Performance";
    src = fetchTarball {
...
"ArrayHash:ver<0.4>" = callPackage ({perl6-on-nix}:
{
    name = "ArrayHash";
    src = fetchTarball {
...
"MagickWand:ver<0.1.0>" = callPackage ({perl6-on-nix}:
{
    name = "MagickWand";
    src = fetchTarball {
...
"App::Assixt:ver<0.2.0>" = callPackage ({perl6-on-nix}:
{
    name = "App::Assixt";
    src = fetchTarball {
...
"P5fileno:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "P5fileno";
    src = fetchTarball {
...
"Map::Agnostic:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Map::Agnostic";
    src = fetchTarball {
...
"Cro::RPC::JSON:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Cro::RPC::JSON";
    src = fetchTarball {
...
"P5pack:ver<0.0.7>" = callPackage ({perl6-on-nix}:
{
    name = "P5pack";
    src = fetchTarball {
...
"Tomtit:ver<0.0.22>" = callPackage ({perl6-on-nix}:
{
    name = "Tomtit";
    src = fetchTarball {
...
"Acme::Cow:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Acme::Cow";
    src = fetchTarball {
...
"Audio::Sndfile:ver<0.0.13>" = callPackage ({perl6-on-nix}:
{
    name = "Audio::Sndfile";
    src = fetchTarball {
...
"Pod::Load:ver<0.4.0>" = callPackage ({perl6-on-nix}:
{
    name = "Pod::Load";
    src = fetchTarball {
...
"VCard:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "VCard";
    src = fetchTarball {
...
"Tomtit:ver<0.0.26>" = callPackage ({perl6-on-nix}:
{
    name = "Tomtit";
    src = fetchTarball {
...
"Crypt::RSA:ver<0.1.0>" = callPackage ({perl6-on-nix}:
{
    name = "Crypt::RSA";
    src = fetchTarball {
...
"AttrX::Mooish:ver<0.2.4>" = callPackage ({perl6-on-nix}:
{
    name = "AttrX::Mooish";
    src = fetchTarball {
...
"Term::Choose::Util:ver<1.2.7>" = callPackage ({perl6-on-nix}:
{
    name = "Term::Choose::Util";
    src = fetchTarball {
...
"Cro::HTTP:ver<0.7.1>" = callPackage ({perl6-on-nix}:
{
    name = "Cro::HTTP";
    src = fetchTarball {
...
"P5getnetbyname:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "P5getnetbyname";
    src = fetchTarball {
...
"P5__FILE__:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "P5__FILE__";
    src = fetchTarball {
...
"Trait::Env:ver<0.3.3>" = callPackage ({perl6-on-nix}:
{
    name = "Trait::Env";
    src = fetchTarball {
...
"App::MPD::AutoQueue:ver<0.1.1>" = callPackage ({perl6-on-nix}:
{
    name = "App::MPD::AutoQueue";
    src = fetchTarball {
...
"Test::Declare:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Test::Declare";
    src = fetchTarball {
...
"App::Assixt:ver<0.2.4>" = callPackage ({perl6-on-nix}:
{
    name = "App::Assixt";
    src = fetchTarball {
...
"Sparrow6:ver<0.0.6>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrow6";
    src = fetchTarball {
...
"XML::XPath:ver<0.9.1>" = callPackage ({perl6-on-nix}:
{
    name = "XML::XPath";
    src = fetchTarball {
...
"Algorithm::LDA:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Algorithm::LDA";
    src = fetchTarball {
...
"Doublephone:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "Doublephone";
    src = fetchTarball {
...
"Text::CSV:ver<0.007>" = callPackage ({perl6-on-nix}:
{
    name = "Text::CSV";
    src = fetchTarball {
...
"ANTLR4::Grammar:ver<0.2.0>" = callPackage ({perl6-on-nix}:
{
    name = "ANTLR4::Grammar";
    src = fetchTarball {
...
"JSON::Fast:ver<0.9.9>" = callPackage ({perl6-on-nix}:
{
    name = "JSON::Fast";
    src = fetchTarball {
...
"TAP:ver<0.0.6>" = callPackage ({perl6-on-nix}:
{
    name = "TAP";
    src = fetchTarball {
...
"Date::Names:ver<1.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Date::Names";
    src = fetchTarball {
...
"Uzu:ver<0.2.4>" = callPackage ({perl6-on-nix}:
{
    name = "Uzu";
    src = fetchTarball {
...
"Matrix::Bot::Plugin::AutoAcceptInvites:ver<0.1.0>" = callPackage ({perl6-on-nix}:
{
...
"PowerNap:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "PowerNap";
    src = fetchTarball {
...
"Sparrow6:ver<0.0.8>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrow6";
    src = fetchTarball {
...
"MeCab:ver<0.0.12>" = callPackage ({perl6-on-nix}:
{
    name = "MeCab";
    src = fetchTarball {
...
"Acme::Test::Module:ver<1.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "Acme::Test::Module";
    src = fetchTarball {
...
"Unix::errno:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Unix::errno";
    src = fetchTarball {
...
"Auth::SCRAM:ver<0.4.7.1>" = callPackage ({perl6-on-nix}:
{
    name = "Auth::SCRAM";
    src = fetchTarball {
...
"Geo::Hash:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Geo::Hash";
    src = fetchTarball {
...
"Grammar::Common:ver<0.2.0>" = callPackage ({perl6-on-nix}:
{
    name = "Grammar::Common";
    src = fetchTarball {
...
"Cro::TLS:ver<0.7.4>" = callPackage ({perl6-on-nix}:
{
    name = "Cro::TLS";
    src = fetchTarball {
...
"Tie::StdHash:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "Tie::StdHash";
    src = fetchTarball {
...
"Object::Delayed:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "Object::Delayed";
    src = fetchTarball {
...
"WebService::Soundcloud:ver<0.0.7>" = callPackage ({perl6-on-nix}:
{
...
"Array::Sparse:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Array::Sparse";
    src = fetchTarball {
...
"JSON::Fast:ver<0.9.8>" = callPackage ({perl6-on-nix}:
{
    name = "JSON::Fast";
    src = fetchTarball {
...
"P5rand:ver<0.0.5>" = callPackage ({perl6-on-nix}:
{
    name = "P5rand";
    src = fetchTarball {
...
"IO::Glob:ver<0.8.1>" = callPackage ({perl6-on-nix}:
{
    name = "IO::Glob";
    src = fetchTarball {
...
"Bailador::Plugin::NamedQueries:ver<0.1001>" = callPackage ({perl6-on-nix}:
{
...
"P5-X:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "P5-X";
    src = fetchTarball {
...
"Algorithm::Evolutionary::Simple:ver<0.0.6>" = callPackage ({perl6-on-nix}:
{
    name = "Algorithm::Evolutionary::Simple";
    src = fetchTarball {
...
"ANTLR4::Grammar:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "ANTLR4::Grammar";
    src = fetchTarball {
...
"Tomtit:ver<0.0.19>" = callPackage ({perl6-on-nix}:
{
    name = "Tomtit";
    src = fetchTarball {
...
"JSON::Fast:ver<0.9.6>" = callPackage ({perl6-on-nix}:
{
    name = "JSON::Fast";
    src = fetchTarball {
...
"Distribution::Builder::MakeFromJSON:ver<0.4>" = callPackage ({perl6-on-nix}:
{
...
"JSON::Path:ver<1.7>" = callPackage ({perl6-on-nix}:
{
    name = "JSON::Path";
    src = fetchTarball {
...
"Graphics::TinyTIFF:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Graphics::TinyTIFF";
    src = fetchTarball {
...
"Trait::Env:ver<0.5.2>" = callPackage ({perl6-on-nix}:
{
    name = "Trait::Env";
    src = fetchTarball {
...
"Sparrowdo::Prometheus:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
...
"Sparrowdo::VSTS::YAML::Build:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowdo::VSTS::YAML::Build";
    src = fetchTarball {
...
"DateTime::Monotonic:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
...
"Amazon::DynamoDB:ver<0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Amazon::DynamoDB";
    src = fetchTarball {
...
"DB:ver<0.2>" = callPackage ({perl6-on-nix}:
{
    name = "DB";
    src = fetchTarball {
...
"Object::Trampoline:ver<0.0.5>" = callPackage ({perl6-on-nix}:
{
    name = "Object::Trampoline";
    src = fetchTarball {
...
"Math::Factorial::Operator:ver<0.1.2>" = callPackage ({perl6-on-nix}:
{
...
"App::Mi6:ver<0.1.1>" = callPackage ({perl6-on-nix}:
{
    name = "App::Mi6";
    src = fetchTarball {
...
"Cro::WebSocket:ver<0.7.1>" = callPackage ({perl6-on-nix}:
{
    name = "Cro::WebSocket";
    src = fetchTarball {
...
"Math::FFT::Libfftw3:ver<0.1.2>" = callPackage ({perl6-on-nix}:
{
...
"Bitcoin::RPC::Client:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Bitcoin::RPC::Client";
    src = fetchTarball {
...
"P5getgrnam:ver<0.0.5>" = callPackage ({perl6-on-nix}:
{
    name = "P5getgrnam";
    src = fetchTarball {
...
"Verge::RPC::Client:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Verge::RPC::Client";
    src = fetchTarball {
...
"List::SomeUtils:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "List::SomeUtils";
    src = fetchTarball {
...
"ANTLR4::Grammar:ver<0.1.1>" = callPackage ({perl6-on-nix}:
{
    name = "ANTLR4::Grammar";
    src = fetchTarball {
...
"ScaleVec:ver<0.0.5>" = callPackage ({perl6-on-nix}:
{
    name = "ScaleVec";
    src = fetchTarball {
...
"Sparky::Plugin::Hello:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
...
"Cro::TLS:ver<0.7.5>" = callPackage ({perl6-on-nix}:
{
    name = "Cro::TLS";
    src = fetchTarball {
...
"Cro::HTTP::Session::Red:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Cro::HTTP::Session::Red";
    src = fetchTarball {
...
"Cro::OpenAPI::RoutesFromDefinition:ver<1.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Cro::OpenAPI::RoutesFromDefinition";
    src = fetchTarball {
...
"Constants::Net::If:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
...
"Grid:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Grid";
    src = fetchTarball {
...
"Sys::Lastlog:ver<0.0.10>" = callPackage ({perl6-on-nix}:
{
    name = "Sys::Lastlog";
    src = fetchTarball {
...
"OpenAPI::Model:ver<1.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "OpenAPI::Model";
    src = fetchTarball {
...
"App::Assixt:ver<0.1.3>" = callPackage ({perl6-on-nix}:
{
    name = "App::Assixt";
    src = fetchTarball {
...
"Random::Choice:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "Random::Choice";
    src = fetchTarball {
...
"Date::Calendar::Hebrew:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
...
"Path::Router:ver<0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Path::Router";
    src = fetchTarball {
...
"Sparrowdo::VSTS::YAML::Solution:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowdo::VSTS::YAML::Solution";
    src = fetchTarball {
...
"P5shift:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "P5shift";
    src = fetchTarball {
...
"AttrX::Mooish:ver<0.4.5>" = callPackage ({perl6-on-nix}:
{
    name = "AttrX::Mooish";
    src = fetchTarball {
...
"TAP:ver<0.0.7>" = callPackage ({perl6-on-nix}:
{
    name = "TAP";
    src = fetchTarball {
...
"App::Unicode::Mangle:ver<1.0.1>" = callPackage ({perl6-on-nix}:
{
...
"Sparrowdo::VSTS::YAML::Cordova:ver<0.0.5>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowdo::VSTS::YAML::Cordova";
    src = fetchTarball {
...
"HTML::Escape:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "HTML::Escape";
    src = fetchTarball {
...
"Gnome::Gtk3::Glade:ver<0.8.6>" = callPackage ({perl6-on-nix}:
{
    name = "Gnome::Gtk3::Glade";
    src = fetchTarball {
...
"Text::Sift4:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Text::Sift4";
    src = fetchTarball {
...
"Sparrowdo:ver<0.0.43>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowdo";
    src = fetchTarball {
...
"Pod::Load:ver<0.5.3>" = callPackage ({perl6-on-nix}:
{
    name = "Pod::Load";
    src = fetchTarball {
...
"App::CPAN:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "App::CPAN";
    src = fetchTarball {
...
"Acme::ಠ_ಠ:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Acme::ಠ_ಠ";
    src = fetchTarball {
...
"P5getpriority:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "P5getpriority";
    src = fetchTarball {
...
"Grammar::PrettyErrors:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Grammar::PrettyErrors";
    src = fetchTarball {
...
"Range::SetOps:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Range::SetOps";
    src = fetchTarball {
...
"Algorithm::Evolutionary::Simple:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "Algorithm::Evolutionary::Simple";
    src = fetchTarball {
...
"IO::Socket::Async::SSL:ver<0.5>" = callPackage ({perl6-on-nix}:
{
    name = "IO::Socket::Async::SSL";
    src = fetchTarball {
...
"CompUnit::Repository::Mask:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
...
"ANTLR4::Grammar:ver<0.6.1>" = callPackage ({perl6-on-nix}:
{
    name = "ANTLR4::Grammar";
    src = fetchTarball {
...
"App::AizuOnlineJudge:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "App::AizuOnlineJudge";
    src = fetchTarball {
...
"Tuple:ver<0.0.5>" = callPackage ({perl6-on-nix}:
{
    name = "Tuple";
    src = fetchTarball {
...
"Smack:ver<0.4.0>" = callPackage ({perl6-on-nix}:
{
    name = "Smack";
    src = fetchTarball {
...
"CommonMark:ver<0.0.5>" = callPackage ({perl6-on-nix}:
{
    name = "CommonMark";
    src = fetchTarball {
...
"Concurrent::Queue:ver<1.0>" = callPackage ({perl6-on-nix}:
{
    name = "Concurrent::Queue";
    src = fetchTarball {
...
"Proc::InvokeEditor:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "Proc::InvokeEditor";
    src = fetchTarball {
...
"Net::netent:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Net::netent";
    src = fetchTarball {
...
"IO::Glob:ver<0.4>" = callPackage ({perl6-on-nix}:
{
    name = "IO::Glob";
    src = fetchTarball {
...
"Fcntl:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Fcntl";
    src = fetchTarball {
...
"META6:ver<0.0.21>" = callPackage ({perl6-on-nix}:
{
    name = "META6";
    src = fetchTarball {
...
"HTML::Lazy:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "HTML::Lazy";
    src = fetchTarball {
...
"Sparrowdo::VSTS::YAML::Cordova:ver<0.0.8>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowdo::VSTS::YAML::Cordova";
    src = fetchTarball {
...
"Image::QRCode:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Image::QRCode";
    src = fetchTarball {
...
"OO::Plugin:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "OO::Plugin";
    src = fetchTarball {
...
"CCLog:ver<0.0.6>" = callPackage ({perl6-on-nix}:
{
    name = "CCLog";
    src = fetchTarball {
...
"Amazon::DynamoDB:ver<0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Amazon::DynamoDB";
    src = fetchTarball {
...
"Concurrent::Stack:ver<1.2>" = callPackage ({perl6-on-nix}:
{
    name = "Concurrent::Stack";
    src = fetchTarball {
...
"Audio::Encode::LameMP3:ver<0.0.11>" = callPackage ({perl6-on-nix}:
{
...
"Term::Choose:ver<1.5.9>" = callPackage ({perl6-on-nix}:
{
    name = "Term::Choose";
    src = fetchTarball {
...
"JSON::Fast:ver<0.9.16>" = callPackage ({perl6-on-nix}:
{
    name = "JSON::Fast";
    src = fetchTarball {
...
"Tomtit:ver<0.0.23>" = callPackage ({perl6-on-nix}:
{
    name = "Tomtit";
    src = fetchTarball {
...
"Trait::Env:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Trait::Env";
    src = fetchTarball {
...
"Terminal::Spinners:ver<1.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Terminal::Spinners";
    src = fetchTarball {
...
"cro:ver<0.7.3>" = callPackage ({perl6-on-nix}:
{
    name = "cro";
    src = fetchTarball {
...
"JSON::Path:ver<1.3>" = callPackage ({perl6-on-nix}:
{
    name = "JSON::Path";
    src = fetchTarball {
...
"Algorithm::MinMaxHeap:ver<0.13.3>" = callPackage ({perl6-on-nix}:
{
...
"Smack:ver<0.3.0>" = callPackage ({perl6-on-nix}:
{
    name = "Smack";
    src = fetchTarball {
...
"P5localtime:ver<0.0.6>" = callPackage ({perl6-on-nix}:
{
    name = "P5localtime";
    src = fetchTarball {
...
"Object::Container:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
...
"Seq::PreFetch:ver<0.1.0>" = callPackage ({perl6-on-nix}:
{
    name = "Seq::PreFetch";
    src = fetchTarball {
...
"App::Uni:ver<1.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "App::Uni";
    src = fetchTarball {
...
"Net::servent:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Net::servent";
    src = fetchTarball {
...
"FastCGI::NativeCall::PSGI:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
...
"P5built-ins:ver<0.0.22>" = callPackage ({perl6-on-nix}:
{
    name = "P5built-ins";
    src = fetchTarball {
...
"License::SPDX:ver<3.5.1>" = callPackage ({perl6-on-nix}:
{
    name = "License::SPDX";
    src = fetchTarball {
...
"IO::Prompt:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "IO::Prompt";
    src = fetchTarball {
...
"Proc::More:ver<0.3.0>" = callPackage ({perl6-on-nix}:
{
    name = "Proc::More";
    src = fetchTarball {
...
"Pod::Load:ver<0.5.4>" = callPackage ({perl6-on-nix}:
{
    name = "Pod::Load";
    src = fetchTarball {
...
"Algorithm::GooglePolylineEncoding:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Algorithm::GooglePolylineEncoding";
    src = fetchTarball {
...
"Algorithm::AhoCorasick:ver<0.0.10>" = callPackage ({perl6-on-nix}:
{
    name = "Algorithm::AhoCorasick";
    src = fetchTarball {
...
"P5shift:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "P5shift";
    src = fetchTarball {
...
"Adverb::Eject:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Adverb::Eject";
    src = fetchTarball {
...
"Terminal::Getpass:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Terminal::Getpass";
    src = fetchTarball {
...
"Graphics::TinyTIFF:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "Graphics::TinyTIFF";
    src = fetchTarball {
...
"Smack:ver<0.2.0>" = callPackage ({perl6-on-nix}:
{
    name = "Smack";
    src = fetchTarball {
...
"Date::Names:ver<1.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Date::Names";
    src = fetchTarball {
...
"App::Unicode::Mangle:ver<1.0.0>" = callPackage ({perl6-on-nix}:
{
    name = "App::Unicode::Mangle";
    src = fetchTarball {
...
"Text::Sift4:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "Text::Sift4";
    src = fetchTarball {
...
"App::MoarVM::ConfprogCompiler:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "App::MoarVM::ConfprogCompiler";
    src = fetchTarball {
...
"Tomtit:ver<0.0.29>" = callPackage ({perl6-on-nix}:
{
    name = "Tomtit";
    src = fetchTarball {
...
"Timer::Breakable:ver<0.1.0>" = callPackage ({perl6-on-nix}:
{
...
"HTTP::Tinyish:ver<0.1.1>" = callPackage ({perl6-on-nix}:
{
    name = "HTTP::Tinyish";
    src = fetchTarball {
...
"Sparrowdo::VSTS::YAML::Cordova:ver<0.0.9>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowdo::VSTS::YAML::Cordova";
    src = fetchTarball {
...
"P5study:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "P5study";
    src = fetchTarball {
...
"Template::Anti:ver<0.5.1>" = callPackage ({perl6-on-nix}:
{
    name = "Template::Anti";
    src = fetchTarball {
...
"Test::Performance:ver<0.1.0>" = callPackage ({perl6-on-nix}:
{
    name = "Test::Performance";
    src = fetchTarball {
...
"Cro::WebSocket:ver<0.7.3>" = callPackage ({perl6-on-nix}:
{
    name = "Cro::WebSocket";
    src = fetchTarball {
...
"META6:ver<0.0.23>" = callPackage ({perl6-on-nix}:
{
    name = "META6";
    src = fetchTarball {
...
"App::Mi6:ver<0.0.7>" = callPackage ({perl6-on-nix}:
{
    name = "App::Mi6";
    src = fetchTarball {
...
"Path::Finder:ver<0.1.0>" = callPackage ({perl6-on-nix}:
{
    name = "Path::Finder";
    src = fetchTarball {
...
"Trait::Env:ver<0.1.1>" = callPackage ({perl6-on-nix}:
{
    name = "Trait::Env";
    src = fetchTarball {
...
"CommonMark:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "CommonMark";
    src = fetchTarball {
...
"P5reset:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "P5reset";
    src = fetchTarball {
...
"File::Stat:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "File::Stat";
    src = fetchTarball {
...
"AttrX::Mooish:ver<0.5.0>" = callPackage ({perl6-on-nix}:
{
    name = "AttrX::Mooish";
    src = fetchTarball {
...
"Cro::HTTP:ver<0.7.2>" = callPackage ({perl6-on-nix}:
{
    name = "Cro::HTTP";
    src = fetchTarball {
...
"Algorithm::GooglePolylineEncoding:ver<1.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Algorithm::GooglePolylineEncoding";
    src = fetchTarball {
...
"HTTP::Tinyish:ver<0.1.0>" = callPackage ({perl6-on-nix}:
{
    name = "HTTP::Tinyish";
    src = fetchTarball {
...
"Cro::Core:ver<0.7.2>" = callPackage ({perl6-on-nix}:
{
    name = "Cro::Core";
    src = fetchTarball {
...
"DB::Pg:ver<0.2>" = callPackage ({perl6-on-nix}:
{
    name = "DB::Pg";
    src = fetchTarball {
...
"Trait::Env:ver<0.4.1>" = callPackage ({perl6-on-nix}:
{
    name = "Trait::Env";
    src = fetchTarball {
...
"IO::Socket::Async::SSL:ver<0.7.3>" = callPackage ({perl6-on-nix}:
{
    name = "IO::Socket::Async::SSL";
    src = fetchTarball {
...
"Readline:ver<0.1.3>" = callPackage ({perl6-on-nix}:
{
    name = "Readline";
    src = fetchTarball {
...
"Graphics::TinyTIFF:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Graphics::TinyTIFF";
    src = fetchTarball {
...
"ProcStats:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "ProcStats";
    src = fetchTarball {
...
"P5caller:ver<0.0.5>" = callPackage ({perl6-on-nix}:
{
    name = "P5caller";
    src = fetchTarball {
...
"Random::Choice:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Random::Choice";
    src = fetchTarball {
...
"Sparrowform:ver<0.0.7>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowform";
    src = fetchTarball {
...
"OpenAPI::Model:ver<1.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "OpenAPI::Model";
    src = fetchTarball {
...
"Acme::Test::Module:ver<1.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Acme::Test::Module";
    src = fetchTarball {
...
"Tomtit:ver<0.0.17>" = callPackage ({perl6-on-nix}:
{
    name = "Tomtit";
    src = fetchTarball {
...
"P5uc:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "P5uc";
    src = fetchTarball {
...
"FindBin::libs:ver<0.2.1>" = callPackage ({perl6-on-nix}:
{
    name = "FindBin::libs";
    src = fetchTarball {
...
"Cro::TLS:ver<0.7.2>" = callPackage ({perl6-on-nix}:
{
    name = "Cro::TLS";
    src = fetchTarball {
...
"HTML::Canvas:ver<0.0.6>" = callPackage ({perl6-on-nix}:
{
    name = "HTML::Canvas";
    src = fetchTarball {
...
"Date::Names:ver<2.0.0>" = callPackage ({perl6-on-nix}:
{
    name = "Date::Names";
    src = fetchTarball {
...
"ANTLR4::Grammar:ver<0.2.1>" = callPackage ({perl6-on-nix}:
{
    name = "ANTLR4::Grammar";
    src = fetchTarball {
...
"Wikidata::API:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Wikidata::API";
    src = fetchTarball {
...
"Physics::Measure:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
...
"App::Platform:ver<0.4.1>" = callPackage ({perl6-on-nix}:
{
    name = "App::Platform";
    src = fetchTarball {
...
"P5each:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "P5each";
    src = fetchTarball {
...
"QM:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "QM";
    src = fetchTarball {
...
"Async::Workers:ver<0.0.8>" = callPackage ({perl6-on-nix}:
{
    name = "Async::Workers";
    src = fetchTarball {
...
"IO::Socket::Async::SSL:ver<0.6>" = callPackage ({perl6-on-nix}:
{
    name = "IO::Socket::Async::SSL";
    src = fetchTarball {
...
"Terminal::Getpass:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Terminal::Getpass";
    src = fetchTarball {
...
"List::MoreUtils:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "List::MoreUtils";
    src = fetchTarball {
...
"Text::Names:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Text::Names";
    src = fetchTarball {
...
"MPD::Client:ver<0.1.3>" = callPackage ({perl6-on-nix}:
{
    name = "MPD::Client";
    src = fetchTarball {
...
"LibGit2:ver<0.2>" = callPackage ({perl6-on-nix}:
{
    name = "LibGit2";
    src = fetchTarball {
...
"Sub::Name:ver<0.0.6>" = callPackage ({perl6-on-nix}:
{
    name = "Sub::Name";
    src = fetchTarball {
...
"Time::Repeat:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Time::Repeat";
    src = fetchTarball {
...
"Object::Container:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Object::Container";
    src = fetchTarball {
...
"Sparrowdo::VSTS::YAML::Build:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowdo::VSTS::YAML::Build";
    src = fetchTarball {
...
"Random::Choice:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Random::Choice";
    src = fetchTarball {
...
"Dist::Helper:ver<0.20.0>" = callPackage ({perl6-on-nix}:
{
    name = "Dist::Helper";
    src = fetchTarball {
...
"Algorithm::Evolutionary::Simple:ver<0.0.8>" = callPackage ({perl6-on-nix}:
{
    name = "Algorithm::Evolutionary::Simple";
    src = fetchTarball {
...
"Lingua::Palindrome:ver<0.1.0>" = callPackage ({perl6-on-nix}:
{
...
"Game::Sudoku:ver<0.1.1>" = callPackage ({perl6-on-nix}:
{
    name = "Game::Sudoku";
    src = fetchTarball {
...
"Perl6::Parser:ver<0.2.0>" = callPackage ({perl6-on-nix}:
{
    name = "Perl6::Parser";
    src = fetchTarball {
...
"Sparrowdo::VSTS::YAML::Nuget:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowdo::VSTS::YAML::Nuget";
    src = fetchTarball {
...
"Pod::To::Pager:ver<0.2.0>" = callPackage ({perl6-on-nix}:
{
    name = "Pod::To::Pager";
    src = fetchTarball {
...
"Perl6::Tidy:ver<0.0.5>" = callPackage ({perl6-on-nix}:
{
    name = "Perl6::Tidy";
    src = fetchTarball {
...
"IO::Socket::Async::SSL:ver<0.7.4>" = callPackage ({perl6-on-nix}:
{
    name = "IO::Socket::Async::SSL";
    src = fetchTarball {
...
"AttrX::Mooish:ver<0.3.0>" = callPackage ({perl6-on-nix}:
{
    name = "AttrX::Mooish";
    src = fetchTarball {
...
"Font::AFM:ver<1.24.2>" = callPackage ({perl6-on-nix}:
{
    name = "Font::AFM";
    src = fetchTarball {
...
"P5chr:ver<0.0.5>" = callPackage ({perl6-on-nix}:
{
    name = "P5chr";
    src = fetchTarball {
...
"Gnome::GObject:ver<0.13.10>" = callPackage ({perl6-on-nix}:
{
    name = "Gnome::GObject";
    src = fetchTarball {
...
"Sys::Hostname:ver<0.0.7>" = callPackage ({perl6-on-nix}:
{
    name = "Sys::Hostname";
    src = fetchTarball {
...
"Config::Parser::yaml:ver<1.0.1>" = callPackage ({perl6-on-nix}:
{
...
"Libarchive:ver<0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Libarchive";
    src = fetchTarball {
...
"LIVR:ver<2.0.0>" = callPackage ({perl6-on-nix}:
{
    name = "LIVR";
    src = fetchTarball {
...
"Test::HTTP::Server:ver<0.4.0>" = callPackage ({perl6-on-nix}:
{
    name = "Test::HTTP::Server";
    src = fetchTarball {
...
"Trait::Env:ver<0.3.0>" = callPackage ({perl6-on-nix}:
{
    name = "Trait::Env";
    src = fetchTarball {
...
"P5substr:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "P5substr";
    src = fetchTarball {
...
"Sparky::Plugin::Notify::Telegram:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Sparky::Plugin::Notify::Telegram";
    src = fetchTarball {
...
"Color::Named:ver<1.001002>" = callPackage ({perl6-on-nix}:
{
    name = "Color::Named";
    src = fetchTarball {
...
"P5index:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "P5index";
    src = fetchTarball {
...
"AttrX::Mooish:ver<0.4.9>" = callPackage ({perl6-on-nix}:
{
    name = "AttrX::Mooish";
    src = fetchTarball {
...
"App::Game::Concentration:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "App::Game::Concentration";
    src = fetchTarball {
...
"Config:ver<2.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Config";
    src = fetchTarball {
...
"Cro::HTTP::Test:ver<0.7.5>" = callPackage ({perl6-on-nix}:
{
    name = "Cro::HTTP::Test";
    src = fetchTarball {
...
"Email::Address:ver<0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Email::Address";
    src = fetchTarball {
...
"Cro::HTTP:ver<0.8.0>" = callPackage ({perl6-on-nix}:
{
    name = "Cro::HTTP";
    src = fetchTarball {
...
"XDG::BaseDirectory:ver<0.0.9>" = callPackage ({perl6-on-nix}:
{
    name = "XDG::BaseDirectory";
    src = fetchTarball {
...
"Uzu:ver<0.2.9>" = callPackage ({perl6-on-nix}:
{
    name = "Uzu";
    src = fetchTarball {
...
"Sparrowform:ver<0.0.9>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowform";
    src = fetchTarball {
...
"Pod::To::Man:ver<0.1.0>" = callPackage ({perl6-on-nix}:
{
    name = "Pod::To::Man";
    src = fetchTarball {
...
"List::Util:ver<0.0.6>" = callPackage ({perl6-on-nix}:
{
    name = "List::Util";
    src = fetchTarball {
...
"Cro::WebSocket:ver<0.7.6>" = callPackage ({perl6-on-nix}:
{
    name = "Cro::WebSocket";
    src = fetchTarball {
...
"CPAN::Uploader::Tiny:ver<0.0.6>" = callPackage ({perl6-on-nix}:
{
    name = "CPAN::Uploader::Tiny";
    src = fetchTarball {
...
"Terminal::Spinners:ver<1.3.0>" = callPackage ({perl6-on-nix}:
{
    name = "Terminal::Spinners";
    src = fetchTarball {
...
"OO::Plugin:ver<0.0.5>" = callPackage ({perl6-on-nix}:
{
    name = "OO::Plugin";
    src = fetchTarball {
...
"AttrX::Mooish:ver<0.2.7>" = callPackage ({perl6-on-nix}:
{
    name = "AttrX::Mooish";
    src = fetchTarball {
...
"Sparrowdo::VSTS::YAML::MsBuild:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
...
"IRC::Client::Plugin::Github:ver<0.1.5>" = callPackage ({perl6-on-nix}:
{
    name = "IRC::Client::Plugin::Github";
    src = fetchTarball {
...
"App::Mi6:ver<0.1.2>" = callPackage ({perl6-on-nix}:
{
    name = "App::Mi6";
    src = fetchTarball {
...
"Log::Minimal:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Log::Minimal";
    src = fetchTarball {
...
"Uzu:ver<0.3.4>" = callPackage ({perl6-on-nix}:
{
    name = "Uzu";
    src = fetchTarball {
...
"ANTLR4::Grammar:ver<0.2.3>" = callPackage ({perl6-on-nix}:
{
    name = "ANTLR4::Grammar";
    src = fetchTarball {
...
"Sparrowdo::VSTS::YAML::Build::Assembly::Patch:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowdo::VSTS::YAML::Build::Assembly::Patch";
    src = fetchTarball {
...
"PDF::Class:ver<0.3.5>" = callPackage ({perl6-on-nix}:
{
    name = "PDF::Class";
    src = fetchTarball {
...
"Pod::Load:ver<0.5.1>" = callPackage ({perl6-on-nix}:
{
    name = "Pod::Load";
    src = fetchTarball {
...
"Audio::Playlist::JSPF:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
...
"Async::Workers:ver<0.0.7>" = callPackage ({perl6-on-nix}:
{
    name = "Async::Workers";
    src = fetchTarball {
...
"Test::HTTP::Server:ver<0.2.1>" = callPackage ({perl6-on-nix}:
{
    name = "Test::HTTP::Server";
    src = fetchTarball {
...
"Algorithm::GooglePolylineEncoding:ver<1.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Algorithm::GooglePolylineEncoding";
    src = fetchTarball {
...
"Inline:ver<1.2.1>" = callPackage ({perl6-on-nix}:
{
    name = "Inline";
    src = fetchTarball {
...
"Test::Script::Output:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
...
"Inline::Perl5:ver<0.39>" = callPackage ({perl6-on-nix}:
{
    name = "Inline::Perl5";
    src = fetchTarball {
...
"Sparrowform:ver<0.0.8>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowform";
    src = fetchTarball {
...
"Net::BGP:ver<0.1.0>" = callPackage ({perl6-on-nix}:
{
    name = "Net::BGP";
    src = fetchTarball {
...
"URI::Template:ver<0.0.7>" = callPackage ({perl6-on-nix}:
{
    name = "URI::Template";
    src = fetchTarball {
...
"Sparrowdo:ver<0.1.1>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowdo";
    src = fetchTarball {
...
"Audio::Convert::Samplerate:ver<0.0.8>" = callPackage ({perl6-on-nix}:
{
...
"AccessorFacade:ver<0.0.9>" = callPackage ({perl6-on-nix}:
{
    name = "AccessorFacade";
    src = fetchTarball {
...
"App::Platform:ver<0.4>" = callPackage ({perl6-on-nix}:
{
    name = "App::Platform";
    src = fetchTarball {
...
"Algorithm::NaiveBayes:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Algorithm::NaiveBayes";
    src = fetchTarball {
...
"Chart::Gnuplot:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "Chart::Gnuplot";
    src = fetchTarball {
...
"Array::Circular:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Array::Circular";
    src = fetchTarball {
...
"Algorithm::Evolutionary::Simple:ver<0.0.7>" = callPackage ({perl6-on-nix}:
{
    name = "Algorithm::Evolutionary::Simple";
    src = fetchTarball {
...
"P5hex:ver<0.0.5>" = callPackage ({perl6-on-nix}:
{
    name = "P5hex";
    src = fetchTarball {
...
"HTTP::Request::FormData:ver<0.1>" = callPackage ({perl6-on-nix}:
{
    name = "HTTP::Request::FormData";
    src = fetchTarball {
...
"Git::Blame:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Git::Blame";
    src = fetchTarball {
...
"App::Mi6:ver<0.2.2>" = callPackage ({perl6-on-nix}:
{
    name = "App::Mi6";
    src = fetchTarball {
...
"Algorithm::LDA:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Algorithm::LDA";
    src = fetchTarball {
...
"CroX::HTTP::Auth::Munge:ver<0.1>" = callPackage ({perl6-on-nix}:
{
...
"LogP6:ver<1.5.2>" = callPackage ({perl6-on-nix}:
{
    name = "LogP6";
    src = fetchTarball {
...
"License::SPDX:ver<3.6.0>" = callPackage ({perl6-on-nix}:
{
    name = "License::SPDX";
    src = fetchTarball {
...
"Tomtit:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "Tomtit";
    src = fetchTarball {
...
"Lumberjack:ver<0.0.9>" = callPackage ({perl6-on-nix}:
{
    name = "Lumberjack";
    src = fetchTarball {
...
"App::Mi6:ver<0.1.7>" = callPackage ({perl6-on-nix}:
{
    name = "App::Mi6";
    src = fetchTarball {
...
"App::Assixt:ver<0.2.2>" = callPackage ({perl6-on-nix}:
{
    name = "App::Assixt";
    src = fetchTarball {
...
"P5lcfirst:ver<0.0.7>" = callPackage ({perl6-on-nix}:
{
    name = "P5lcfirst";
    src = fetchTarball {
...
"Tinky:ver<0.0.8>" = callPackage ({perl6-on-nix}:
{
    name = "Tinky";
    src = fetchTarball {
...
"Tomtit:ver<0.1.0>" = callPackage ({perl6-on-nix}:
{
    name = "Tomtit";
    src = fetchTarball {
...
"DOM::Tiny:ver<0.5.0>" = callPackage ({perl6-on-nix}:
{
    name = "DOM::Tiny";
    src = fetchTarball {
...
"Term::TablePrint:ver<1.4.8>" = callPackage ({perl6-on-nix}:
{
    name = "Term::TablePrint";
    src = fetchTarball {
...
"Stream::Buffered:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
...
"Cro::HTTP::Test:ver<0.8.0>" = callPackage ({perl6-on-nix}:
{
    name = "Cro::HTTP::Test";
    src = fetchTarball {
...
"Smack:ver<0.1.2>" = callPackage ({perl6-on-nix}:
{
    name = "Smack";
    src = fetchTarball {
...
"Sparrowdo::VSTS::YAML::Cordova:ver<0.0.6>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowdo::VSTS::YAML::Cordova";
    src = fetchTarball {
...
"OO::Plugin:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "OO::Plugin";
    src = fetchTarball {
...
"JSON::Class:ver<0.0.12>" = callPackage ({perl6-on-nix}:
{
    name = "JSON::Class";
    src = fetchTarball {
...
"Sparrowdo::VSTS::YAML::Angular::Build:ver<0.0.6>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowdo::VSTS::YAML::Angular::Build";
    src = fetchTarball {
...
"List::SomeUtils:ver<0.0.5>" = callPackage ({perl6-on-nix}:
{
    name = "List::SomeUtils";
    src = fetchTarball {
...
"Libui:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Libui";
    src = fetchTarball {
...
"ANTLR4::Grammar:ver<0.2.2>" = callPackage ({perl6-on-nix}:
{
    name = "ANTLR4::Grammar";
    src = fetchTarball {
...
"JSON::Class:ver<0.0.11>" = callPackage ({perl6-on-nix}:
{
    name = "JSON::Class";
    src = fetchTarball {
...
"Sparrowdo::VSTS::YAML::Build:ver<0.0.7>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowdo::VSTS::YAML::Build";
    src = fetchTarball {
...
"App::Assixt:ver<0.2.3>" = callPackage ({perl6-on-nix}:
{
    name = "App::Assixt";
    src = fetchTarball {
...
"HTTP::Server::Tiny:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
...
"AccessorFacade:ver<0.0.8>" = callPackage ({perl6-on-nix}:
{
    name = "AccessorFacade";
    src = fetchTarball {
...
"OO::Plugin:ver<0.0.7>" = callPackage ({perl6-on-nix}:
{
    name = "OO::Plugin";
    src = fetchTarball {
...
"Trait::Env:ver<0.4.0>" = callPackage ({perl6-on-nix}:
{
    name = "Trait::Env";
    src = fetchTarball {
...
"SDL2:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "SDL2";
    src = fetchTarball {
...
"Sparrowdo::VSTS::YAML::Nuget::Build:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowdo::VSTS::YAML::Nuget::Build";
    src = fetchTarball {
...
"TCP::LowLevel:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "TCP::LowLevel";
    src = fetchTarball {
...
"FINALIZER:ver<0.0.5>" = callPackage ({perl6-on-nix}:
{
    name = "FINALIZER";
    src = fetchTarball {
...
"Hash::Restricted:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Hash::Restricted";
    src = fetchTarball {
...
"JSON::Path:ver<1.4>" = callPackage ({perl6-on-nix}:
{
    name = "JSON::Path";
    src = fetchTarball {
...
"Cro::WebSocket:ver<0.7.2>" = callPackage ({perl6-on-nix}:
{
    name = "Cro::WebSocket";
    src = fetchTarball {
...
"FindBin::libs:ver<0.1.2>" = callPackage ({perl6-on-nix}:
{
    name = "FindBin::libs";
    src = fetchTarball {
...
"Native::Exec:ver<0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Native::Exec";
    src = fetchTarball {
...
"PDF::Font::Loader:ver<0.2.3>" = callPackage ({perl6-on-nix}:
{
    name = "PDF::Font::Loader";
    src = fetchTarball {
...
"P5math:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "P5math";
    src = fetchTarball {
...
"LIVR:ver<2.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "LIVR";
    src = fetchTarball {
...
"Algorithm::AhoCorasick:ver<0.0.9>" = callPackage ({perl6-on-nix}:
{
    name = "Algorithm::AhoCorasick";
    src = fetchTarball {
...
"Sparrow6:ver<0.0.5>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrow6";
    src = fetchTarball {
...
"Inline::Perl5:ver<0.32>" = callPackage ({perl6-on-nix}:
{
    name = "Inline::Perl5";
    src = fetchTarball {
...
"Sparrowform:ver<0.0.15>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowform";
    src = fetchTarball {
...
"P5length:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "P5length";
    src = fetchTarball {
...
"Seq::Bounded:ver<1.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Seq::Bounded";
    src = fetchTarball {
...
"Cro::TLS:ver<0.8.1>" = callPackage ({perl6-on-nix}:
{
    name = "Cro::TLS";
    src = fetchTarball {
...
"US-ASCII:ver<0.6.5>" = callPackage ({perl6-on-nix}:
{
    name = "US-ASCII";
    src = fetchTarball {
...
"P5ref:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "P5ref";
    src = fetchTarball {
...
"Sparrowdo::VSTS::YAML::Build:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowdo::VSTS::YAML::Build";
    src = fetchTarball {
...
"Cro::HTTP:ver<0.8.1>" = callPackage ({perl6-on-nix}:
{
    name = "Cro::HTTP";
    src = fetchTarball {
...
"App::MoarVM::ConfprogCompiler:ver<0.0.5>" = callPackage ({perl6-on-nix}:
{
    name = "App::MoarVM::ConfprogCompiler";
    src = fetchTarball {
...
"P5oct:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "P5oct";
    src = fetchTarball {
...
"Cro::HTTP:ver<0.7.4>" = callPackage ({perl6-on-nix}:
{
    name = "Cro::HTTP";
    src = fetchTarball {
...
"Sparrowform:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowform";
    src = fetchTarball {
...
"Cro::ZeroMQ:ver<0.8.1>" = callPackage ({perl6-on-nix}:
{
    name = "Cro::ZeroMQ";
    src = fetchTarball {
...
"Term::TablePrint:ver<1.4.9>" = callPackage ({perl6-on-nix}:
{
    name = "Term::TablePrint";
    src = fetchTarball {
...
"Tomtit:ver<0.0.25>" = callPackage ({perl6-on-nix}:
{
    name = "Tomtit";
    src = fetchTarball {
...
"Algorithm::AhoCorasick:ver<0.0.11>" = callPackage ({perl6-on-nix}:
{
    name = "Algorithm::AhoCorasick";
    src = fetchTarball {
...
"DB::Xoos:ver<0.0.13>" = callPackage ({perl6-on-nix}:
{
    name = "DB::Xoos";
    src = fetchTarball {
...
"App::Assixt:ver<0.2.1>" = callPackage ({perl6-on-nix}:
{
    name = "App::Assixt";
    src = fetchTarball {
...
"Inline::Perl5:ver<0.36>" = callPackage ({perl6-on-nix}:
{
    name = "Inline::Perl5";
    src = fetchTarball {
...
"Array::Agnostic:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Array::Agnostic";
    src = fetchTarball {
...
"App::Tasks:ver<0.0.15>" = callPackage ({perl6-on-nix}:
{
    name = "App::Tasks";
    src = fetchTarball {
...
"JSON::Schema:ver<0.9>" = callPackage ({perl6-on-nix}:
{
    name = "JSON::Schema";
    src = fetchTarball {
...
"Perl6::Ecosystem:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Perl6::Ecosystem";
    src = fetchTarball {
...
"MeCab:ver<0.0.7>" = callPackage ({perl6-on-nix}:
{
    name = "MeCab";
    src = fetchTarball {
...
"JSON::Fast:ver<0.9.18>" = callPackage ({perl6-on-nix}:
{
    name = "JSON::Fast";
    src = fetchTarball {
...
"Crypt::Libcrypt:ver<0.0.9>" = callPackage ({perl6-on-nix}:
{
    name = "Crypt::Libcrypt";
    src = fetchTarball {
...
"Inline::Perl5:ver<0.40>" = callPackage ({perl6-on-nix}:
{
    name = "Inline::Perl5";
    src = fetchTarball {
...
"SQL::Lexer:ver<0.2.0>" = callPackage ({perl6-on-nix}:
{
    name = "SQL::Lexer";
    src = fetchTarball {
...
"App::Mi6:ver<0.2.4>" = callPackage ({perl6-on-nix}:
{
    name = "App::Mi6";
    src = fetchTarball {
...
"Image::Libexif:ver<0.1.0>" = callPackage ({perl6-on-nix}:
{
    name = "Image::Libexif";
    src = fetchTarball {
...
"Lingua::Stopwords:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Lingua::Stopwords";
    src = fetchTarball {
...
"Array::Agnostic:ver<0.0.6>" = callPackage ({perl6-on-nix}:
{
    name = "Array::Agnostic";
    src = fetchTarball {
...
"Map::Ordered:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Map::Ordered";
    src = fetchTarball {
...
"CroX::HTTP::FallbackPassthru:ver<0.1>" = callPackage ({perl6-on-nix}:
{
...
"Cro::ZeroMQ:ver<0.7.2>" = callPackage ({perl6-on-nix}:
{
    name = "Cro::ZeroMQ";
    src = fetchTarball {
...
"AttrX::Mooish:ver<0.2.1>" = callPackage ({perl6-on-nix}:
{
    name = "AttrX::Mooish";
    src = fetchTarball {
...
"Cro::TLS:ver<0.8.0>" = callPackage ({perl6-on-nix}:
{
    name = "Cro::TLS";
    src = fetchTarball {
...
"ProcStats:ver<0.1.0>" = callPackage ({perl6-on-nix}:
{
    name = "ProcStats";
    src = fetchTarball {
...
"Tomtit:ver<0.0.16>" = callPackage ({perl6-on-nix}:
{
    name = "Tomtit";
    src = fetchTarball {
...
"Chart::Gnuplot:ver<0.0.9>" = callPackage ({perl6-on-nix}:
{
    name = "Chart::Gnuplot";
    src = fetchTarball {
...
"Tie::StdArray:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Tie::StdArray";
    src = fetchTarball {
...
"Algorithm::GooglePolylineEncoding:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Algorithm::GooglePolylineEncoding";
    src = fetchTarball {
...
"Manifesto:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "Manifesto";
    src = fetchTarball {
...
"P5readlink:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "P5readlink";
    src = fetchTarball {
...
"FindBin::libs:ver<0.1.0>" = callPackage ({perl6-on-nix}:
{
    name = "FindBin::libs";
    src = fetchTarball {
...
"Terminal::Table:ver<0.0.7>" = callPackage ({perl6-on-nix}:
{
    name = "Terminal::Table";
    src = fetchTarball {
...
"Test::HTTP::Server:ver<0.2.0>" = callPackage ({perl6-on-nix}:
{
    name = "Test::HTTP::Server";
    src = fetchTarball {
...
"Dist::Helper:ver<1.0.0>" = callPackage ({perl6-on-nix}:
{
    name = "Dist::Helper";
    src = fetchTarball {
...
"Graphics::TinyTIFF:ver<0.0.6>" = callPackage ({perl6-on-nix}:
{
    name = "Graphics::TinyTIFF";
    src = fetchTarball {
...
"P5chomp:ver<0.0.5>" = callPackage ({perl6-on-nix}:
{
    name = "P5chomp";
    src = fetchTarball {
...
"User::pwent:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "User::pwent";
    src = fetchTarball {
...
"P5times:ver<0.0.6>" = callPackage ({perl6-on-nix}:
{
    name = "P5times";
    src = fetchTarball {
...
"OO::Plugin:ver<0.0.6>" = callPackage ({perl6-on-nix}:
{
    name = "OO::Plugin";
    src = fetchTarball {
...
"Net::BGP:ver<0.1.1>" = callPackage ({perl6-on-nix}:
{
    name = "Net::BGP";
    src = fetchTarball {
...
"Sub::Util:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Sub::Util";
    src = fetchTarball {
...
"Tomtit:ver<0.0.8>" = callPackage ({perl6-on-nix}:
{
    name = "Tomtit";
    src = fetchTarball {
...
"CI::Gen:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "CI::Gen";
    src = fetchTarball {
...
"Tomtit:ver<0.0.20>" = callPackage ({perl6-on-nix}:
{
    name = "Tomtit";
    src = fetchTarball {
...
"HTTP::Request::Supply:ver<0.2.0>" = callPackage ({perl6-on-nix}:
{
    name = "HTTP::Request::Supply";
    src = fetchTarball {
...
"RPi::Device::PiGlow:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "RPi::Device::PiGlow";
    src = fetchTarball {
...
"Terminal::Spinners:ver<1.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Terminal::Spinners";
    src = fetchTarball {
...
"FindBin:ver<0.4.3>" = callPackage ({perl6-on-nix}:
{
    name = "FindBin";
    src = fetchTarball {
...
"Term::Form:ver<1.2.6>" = callPackage ({perl6-on-nix}:
{
    name = "Term::Form";
    src = fetchTarball {
...
"Pod::Render:ver<0.8.0>" = callPackage ({perl6-on-nix}:
{
    name = "Pod::Render";
    src = fetchTarball {
...
"Sparrowform:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowform";
    src = fetchTarball {
...
"Magento:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Magento";
    src = fetchTarball {
...
"IRC::Client::Plugin::Ignore:ver<0.1.0>" = callPackage ({perl6-on-nix}:
{
...
"Cro::Core:ver<0.7.3>" = callPackage ({perl6-on-nix}:
{
    name = "Cro::Core";
    src = fetchTarball {
...
"vars:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "vars";
    src = fetchTarball {
...
"Uzu:ver<0.3.3>" = callPackage ({perl6-on-nix}:
{
    name = "Uzu";
    src = fetchTarball {
...
"JSON::Fast:ver<0.9.13>" = callPackage ({perl6-on-nix}:
{
    name = "JSON::Fast";
    src = fetchTarball {
...
"JSON::Name:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "JSON::Name";
    src = fetchTarball {
...
"List::UtilsBy:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "List::UtilsBy";
    src = fetchTarball {
...
"Sparrowdo::VSTS::YAML::DotNet:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowdo::VSTS::YAML::DotNet";
    src = fetchTarball {
...
"Sparrowdo:ver<0.0.36>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowdo";
    src = fetchTarball {
...
"Text::Sift4:ver<0.0.6>" = callPackage ({perl6-on-nix}:
{
    name = "Text::Sift4";
    src = fetchTarball {
...
"Matrix::Bot:ver<0.2.0>" = callPackage ({perl6-on-nix}:
{
    name = "Matrix::Bot";
    src = fetchTarball {
...
"Tinky::Hash:ver<0.4.2.7>" = callPackage ({perl6-on-nix}:
{
    name = "Tinky::Hash";
    src = fetchTarball {
...
"Algorithm::GooglePolylineEncoding:ver<1.0.0>" = callPackage ({perl6-on-nix}:
{
    name = "Algorithm::GooglePolylineEncoding";
    src = fetchTarball {
...
"Libui:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Libui";
    src = fetchTarball {
...
"Sparrowdo::Cordova::OSx::Build:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowdo::Cordova::OSx::Build";
    src = fetchTarball {
...
"App::Prove6:ver<0.0.8>" = callPackage ({perl6-on-nix}:
{
    name = "App::Prove6";
    src = fetchTarball {
...
"App::Tasks:ver<0.0.14>" = callPackage ({perl6-on-nix}:
{
    name = "App::Tasks";
    src = fetchTarball {
...
"Result:ver<0.1.0>" = callPackage ({perl6-on-nix}:
{
    name = "Result";
    src = fetchTarball {
...
"AttrX::Mooish:ver<0.4.1>" = callPackage ({perl6-on-nix}:
{
    name = "AttrX::Mooish";
    src = fetchTarball {
...
"Temp::Path:ver<1.001007>" = callPackage ({perl6-on-nix}:
{
    name = "Temp::Path";
    src = fetchTarball {
...
"OAuth2::Client::Google:ver<0.1.1>" = callPackage ({perl6-on-nix}:
{
    name = "OAuth2::Client::Google";
    src = fetchTarball {
...
"Gnome::Gdk3:ver<0.14.9>" = callPackage ({perl6-on-nix}:
{
    name = "Gnome::Gdk3";
    src = fetchTarball {
...
"OO::Plugin:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "OO::Plugin";
    src = fetchTarball {
...
"HTTP::API::Pingdom:ver<0.1.0>" = callPackage ({perl6-on-nix}:
{
...
"POFile:ver<0.7.2>" = callPackage ({perl6-on-nix}:
{
    name = "POFile";
    src = fetchTarball {
...
"Getopt::Long:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Getopt::Long";
    src = fetchTarball {
...
"Terminal::Getpass:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "Terminal::Getpass";
    src = fetchTarball {
...
"JSON::Schema:ver<0.8>" = callPackage ({perl6-on-nix}:
{
    name = "JSON::Schema";
    src = fetchTarball {
...
"XML::Actions:ver<0.3.1.3>" = callPackage ({perl6-on-nix}:
{
    name = "XML::Actions";
    src = fetchTarball {
...
"Sparky::Plugin::Hello:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Sparky::Plugin::Hello";
    src = fetchTarball {
...
"Pygments:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Pygments";
    src = fetchTarball {
...
"Concurrent::Trie:ver<1.1>" = callPackage ({perl6-on-nix}:
{
...
"Method::Also:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Method::Also";
    src = fetchTarball {
...
"cro:ver<0.8.0>" = callPackage ({perl6-on-nix}:
{
    name = "cro";
    src = fetchTarball {
...
"DB::MySQL:ver<0.4>" = callPackage ({perl6-on-nix}:
{
    name = "DB::MySQL";
    src = fetchTarball {
...
"Object::Delayed:ver<0.0.6>" = callPackage ({perl6-on-nix}:
{
    name = "Object::Delayed";
    src = fetchTarball {
...
"Igo:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Igo";
    src = fetchTarball {
...
"RPi::Device::SMBus:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "RPi::Device::SMBus";
    src = fetchTarball {
...
"License::SPDX:ver<3.4.0>" = callPackage ({perl6-on-nix}:
{
    name = "License::SPDX";
    src = fetchTarball {
...
"Pod::To::Pager:ver<0.1.0>" = callPackage ({perl6-on-nix}:
{
    name = "Pod::To::Pager";
    src = fetchTarball {
...
"Sparky:ver<0.0.23>" = callPackage ({perl6-on-nix}:
{
    name = "Sparky";
    src = fetchTarball {
...
"Attribute::Lazy:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "Attribute::Lazy";
    src = fetchTarball {
...
"Hash::Agnostic:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Hash::Agnostic";
    src = fetchTarball {
...
"HTML::Canvas::To::PDF:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "HTML::Canvas::To::PDF";
    src = fetchTarball {
...
"Inline:ver<v.1>" = callPackage ({perl6-on-nix}:
{
    name = "Inline";
    src = fetchTarball {
...
"JSON::Name:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "JSON::Name";
    src = fetchTarball {
...
"Util::Bitfield:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "Util::Bitfield";
    src = fetchTarball {
...
"Cro::TLS:ver<0.7.1>" = callPackage ({perl6-on-nix}:
{
    name = "Cro::TLS";
    src = fetchTarball {
...
"Perl6::Tidy:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Perl6::Tidy";
    src = fetchTarball {
...
"Cro::WebSocket:ver<0.7.5>" = callPackage ({perl6-on-nix}:
{
    name = "Cro::WebSocket";
    src = fetchTarball {
...
"Perl6::Tidy:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "Perl6::Tidy";
    src = fetchTarball {
...
"IRC::Client::Plugin::NickServ:ver<0.1.0>" = callPackage ({perl6-on-nix}:
{
    name = "IRC::Client::Plugin::NickServ";
    src = fetchTarball {
...
"Cro::HTTP:ver<0.7.5>" = callPackage ({perl6-on-nix}:
{
    name = "Cro::HTTP";
    src = fetchTarball {
...
"Sparrowdo::VSTS::YAML::MsBuild:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowdo::VSTS::YAML::MsBuild";
    src = fetchTarball {
...
"Terminal::Getpass:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Terminal::Getpass";
    src = fetchTarball {
...
"Config:ver<1.3.1>" = callPackage ({perl6-on-nix}:
{
    name = "Config";
    src = fetchTarball {
...
"Tomtit:ver<0.0.18>" = callPackage ({perl6-on-nix}:
{
    name = "Tomtit";
    src = fetchTarball {
...
"Audio::Fingerprint::Chromaprint:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
...
"Printing::Jdf:ver<0.1.1>" = callPackage ({perl6-on-nix}:
{
    name = "Printing::Jdf";
    src = fetchTarball {
...
"Tomtit:ver<0.0.6>" = callPackage ({perl6-on-nix}:
{
    name = "Tomtit";
    src = fetchTarball {
...
"RDF::Turtle:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "RDF::Turtle";
    src = fetchTarball {
...
"WriteOnceHash:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "WriteOnceHash";
    src = fetchTarball {
...
"Libui:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Libui";
    src = fetchTarball {
...
"HTTP::Tinyish:ver<0.1.3>" = callPackage ({perl6-on-nix}:
{
    name = "HTTP::Tinyish";
    src = fetchTarball {
...
"App::Mi6:ver<0.2.3>" = callPackage ({perl6-on-nix}:
{
    name = "App::Mi6";
    src = fetchTarball {
...
"Audio::Liquidsoap:ver<0.0.7>" = callPackage ({perl6-on-nix}:
{
...
"Archive::Libarchive::Raw:ver<0.0.9>" = callPackage ({perl6-on-nix}:
{
...
"Date::Names:ver<2.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Date::Names";
    src = fetchTarball {
...
"AWS::Session:ver<0.2>" = callPackage ({perl6-on-nix}:
{
    name = "AWS::Session";
    src = fetchTarball {
...
"Template::Prometheus:ver<0.1.0>" = callPackage ({perl6-on-nix}:
{
...
"FileSystem::Parent:ver<0.2.1>" = callPackage ({perl6-on-nix}:
{
    name = "FileSystem::Parent";
    src = fetchTarball {
...
"Sparrowdo:ver<0.0.37>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowdo";
    src = fetchTarball {
...
"Math::Vector3D:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Math::Vector3D";
    src = fetchTarball {
...
"LibUUID:ver<0.4>" = callPackage ({perl6-on-nix}:
{
    name = "LibUUID";
    src = fetchTarball {
...
"P5localtime:ver<0.0.5>" = callPackage ({perl6-on-nix}:
{
    name = "P5localtime";
    src = fetchTarball {
...
"Object::Delayed:ver<0.0.5>" = callPackage ({perl6-on-nix}:
{
    name = "Object::Delayed";
    src = fetchTarball {
...
"App::Assixt:ver<0.5.0>" = callPackage ({perl6-on-nix}:
{
    name = "App::Assixt";
    src = fetchTarball {
...
"Trait::Env:ver<0.5.0>" = callPackage ({perl6-on-nix}:
{
    name = "Trait::Env";
    src = fetchTarball {
...
"JSON::Tiny:ver<1.0>" = callPackage ({perl6-on-nix}:
{
    name = "JSON::Tiny";
    src = fetchTarball {
...
"Term::Choose:ver<1.5.8>" = callPackage ({perl6-on-nix}:
{
    name = "Term::Choose";
    src = fetchTarball {
...
"Uzu:ver<0.3.1>" = callPackage ({perl6-on-nix}:
{
    name = "Uzu";
    src = fetchTarball {
...
"Cro::ZeroMQ:ver<0.7.4>" = callPackage ({perl6-on-nix}:
{
    name = "Cro::ZeroMQ";
    src = fetchTarball {
...
"WriteOnceHash:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "WriteOnceHash";
    src = fetchTarball {
...
"Audio::Silan:ver<0.0.7>" = callPackage ({perl6-on-nix}:
{
    name = "Audio::Silan";
    src = fetchTarball {
...
"Perl6::Tidy:ver<0.0.7>" = callPackage ({perl6-on-nix}:
{
    name = "Perl6::Tidy";
    src = fetchTarball {
...
"Chart::Gnuplot:ver<0.0.10>" = callPackage ({perl6-on-nix}:
{
    name = "Chart::Gnuplot";
    src = fetchTarball {
...
"Cro::WebSocket:ver<0.8.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Cro::WebSocket";
    src = fetchTarball {
...
"Hash::Agnostic:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Hash::Agnostic";
    src = fetchTarball {
...
"PDF::Class:ver<0.3.6>" = callPackage ({perl6-on-nix}:
{
    name = "PDF::Class";
    src = fetchTarball {
...
"Cro::ZeroMQ:ver<0.7.5>" = callPackage ({perl6-on-nix}:
{
    name = "Cro::ZeroMQ";
    src = fetchTarball {
...
"Uzu:ver<0.2.7>" = callPackage ({perl6-on-nix}:
{
    name = "Uzu";
    src = fetchTarball {
...
"App::MoarVM::ConfprogCompiler:ver<0.0.8>" = callPackage ({perl6-on-nix}:
{
    name = "App::MoarVM::ConfprogCompiler";
    src = fetchTarball {
...
"FileSystem::Parent:ver<0.3.3>" = callPackage ({perl6-on-nix}:
{
    name = "FileSystem::Parent";
    src = fetchTarball {
...
"Sparrowdo:ver<0.0.40>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowdo";
    src = fetchTarball {
...
"WriteOnceHash:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "WriteOnceHash";
    src = fetchTarball {
...
"Munge:ver<0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Munge";
    src = fetchTarball {
...
"File::XML::DMARC::Google:ver<0.1.0>" = callPackage ({perl6-on-nix}:
{
    name = "File::XML::DMARC::Google";
    src = fetchTarball {
...
"Supply::Timeout:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Supply::Timeout";
    src = fetchTarball {
...
"HTTP::Headers:ver<0.2>" = callPackage ({perl6-on-nix}:
{
    name = "HTTP::Headers";
    src = fetchTarball {
...
"Digest::BubbleBabble:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
...
"SDL2::Raw:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "SDL2::Raw";
    src = fetchTarball {
...
"Tinky::JSON:ver<0.0.5>" = callPackage ({perl6-on-nix}:
{
    name = "Tinky::JSON";
    src = fetchTarball {
...
"Path::Router:ver<0.5.0>" = callPackage ({perl6-on-nix}:
{
    name = "Path::Router";
    src = fetchTarball {
...
"Algorithm::MinMaxHeap:ver<0.13.4>" = callPackage ({perl6-on-nix}:
{
    name = "Algorithm::MinMaxHeap";
    src = fetchTarball {
...
"Sparrowdo::Cordova::OSx::Build:ver<0.0.5>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowdo::Cordova::OSx::Build";
    src = fetchTarball {
...
"LibCurl:ver<0.6>" = callPackage ({perl6-on-nix}:
{
    name = "LibCurl";
    src = fetchTarball {
...
"BSON:ver<0.11.6>" = callPackage ({perl6-on-nix}:
{
    name = "BSON";
    src = fetchTarball {
...
"Array::Sparse:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "Array::Sparse";
    src = fetchTarball {
...
"File::Zip:ver<0.1.2>" = callPackage ({perl6-on-nix}:
{
    name = "File::Zip";
    src = fetchTarball {
...
"WebService::AWS::S3:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "WebService::AWS::S3";
    src = fetchTarball {
...
"P5tie:ver<0.0.11>" = callPackage ({perl6-on-nix}:
{
    name = "P5tie";
    src = fetchTarball {
...
"Bailador::Plugin::NamedQueries:ver<0.001000>" = callPackage ({perl6-on-nix}:
{
    name = "Bailador::Plugin::NamedQueries";
    src = fetchTarball {
...
"Test::META:ver<0.0.15>" = callPackage ({perl6-on-nix}:
{
    name = "Test::META";
    src = fetchTarball {
...
"KHPH:ver<0.0.9>" = callPackage ({perl6-on-nix}:
{
    name = "KHPH";
    src = fetchTarball {
...
"Sparrowdo:ver<0.0.42>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowdo";
    src = fetchTarball {
...
"CCLog:ver<0.0.5>" = callPackage ({perl6-on-nix}:
{
    name = "CCLog";
    src = fetchTarball {
...
"PDF::ISO_32000:ver<0.0.6>" = callPackage ({perl6-on-nix}:
{
    name = "PDF::ISO_32000";
    src = fetchTarball {
...
"Sparrowdo::VSTS::YAML::Cordova:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowdo::VSTS::YAML::Cordova";
    src = fetchTarball {
...
"Sparrowdo::VSTS::YAML::Build::Assembly::Patch:ver<1.0.0>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowdo::VSTS::YAML::Build::Assembly::Patch";
    src = fetchTarball {
...
"Number::More:ver<0.2.0>" = callPackage ({perl6-on-nix}:
{
    name = "Number::More";
    src = fetchTarball {
...
"IRC::Client::Plugin::UrlTitle:ver<1.1.3>" = callPackage ({perl6-on-nix}:
{
    name = "IRC::Client::Plugin::UrlTitle";
    src = fetchTarball {
...
"SQL::Lexer:ver<0.2.1>" = callPackage ({perl6-on-nix}:
{
    name = "SQL::Lexer";
    src = fetchTarball {
...
"Inline:ver<v.1.1>" = callPackage ({perl6-on-nix}:
{
    name = "Inline";
    src = fetchTarball {
...
"IoC:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "IoC";
    src = fetchTarball {
...
"JSON::Path:ver<1.5>" = callPackage ({perl6-on-nix}:
{
    name = "JSON::Path";
    src = fetchTarball {
...
"Hash::MultiValue:ver<0.7>" = callPackage ({perl6-on-nix}:
{
    name = "Hash::MultiValue";
    src = fetchTarball {
...
"String::Fold:ver<0.1.0>" = callPackage ({perl6-on-nix}:
{
    name = "String::Fold";
    src = fetchTarball {
...
"Config:ver<1.3.5>" = callPackage ({perl6-on-nix}:
{
    name = "Config";
    src = fetchTarball {
...
"Sparrowdo::VSTS::YAML::Cordova:ver<0.0.7>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowdo::VSTS::YAML::Cordova";
    src = fetchTarball {
...
"P5ord:ver<0.0.5>" = callPackage ({perl6-on-nix}:
{
    name = "P5ord";
    src = fetchTarball {
...
"Operator::grandpa:ver<1.001001>" = callPackage ({perl6-on-nix}:
{
...
"P5getgrnam:ver<0.0.6>" = callPackage ({perl6-on-nix}:
{
    name = "P5getgrnam";
    src = fetchTarball {
...
"Font::FreeType:ver<0.2.0>" = callPackage ({perl6-on-nix}:
{
    name = "Font::FreeType";
    src = fetchTarball {
...
"StrictClass:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "StrictClass";
    src = fetchTarball {
...
"Sparrowdo::Azure::Web::Cert:ver<0.0.2>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowdo::Azure::Web::Cert";
    src = fetchTarball {
...
"OEIS:ver<1.0.0>" = callPackage ({perl6-on-nix}:
{
    name = "OEIS";
    src = fetchTarball {
...
"App::Mi6:ver<0.1.6>" = callPackage ({perl6-on-nix}:
{
    name = "App::Mi6";
    src = fetchTarball {
...
"Timer::Breakable:ver<0.1.1>" = callPackage ({perl6-on-nix}:
{
    name = "Timer::Breakable";
    src = fetchTarball {
...
"TAP:ver<0.0.9>" = callPackage ({perl6-on-nix}:
{
    name = "TAP";
    src = fetchTarball {
...
"JSON::Fast:ver<0.9.5>" = callPackage ({perl6-on-nix}:
{
    name = "JSON::Fast";
    src = fetchTarball {
...
"Hash::Restricted:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "Hash::Restricted";
    src = fetchTarball {
...
"Sparrowdo::Cordova::OSx::Build:ver<0.0.6>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowdo::Cordova::OSx::Build";
    src = fetchTarball {
...
"Scalar::Util:ver<0.0.5>" = callPackage ({perl6-on-nix}:
{
    name = "Scalar::Util";
    src = fetchTarball {
...
"String::Fold:ver<0.1.1>" = callPackage ({perl6-on-nix}:
{
    name = "String::Fold";
    src = fetchTarball {
...
"Dist::Helper:ver<0.19.1>" = callPackage ({perl6-on-nix}:
{
    name = "Dist::Helper";
    src = fetchTarball {
...
"Memoize:ver<0.0.3>" = callPackage ({perl6-on-nix}:
{
    name = "Memoize";
    src = fetchTarball {
...
"Sparrowdo::VSTS::YAML::Solution:ver<0.0.4>" = callPackage ({perl6-on-nix}:
{
    name = "Sparrowdo::VSTS::YAML::Solution";
    src = fetchTarball {
...
"Doublephone:ver<0.0.5>" = callPackage ({perl6-on-nix}:
{
    name = "Doublephone";
    src = fetchTarball {
...
"Pod::Load:ver<0.0.1>" = callPackage ({perl6-on-nix}:
{
    name = "Pod::Load";
    src = fetchTarball {
