...
=head3 meta62nixscripts cpan generate-nix scripts/cache/cpan

Generate a Nix expression for each library from CPAN that is in the CPAN
cache. Will download archives if necessary.
